...
/**
 * GetExposedTransportsResponse.java
 *
 ...
 */
            ...
            /**
            *  GetExposedTransportsResponse bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class GetExposedTransportsResponse
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":getExposedTransportsResponse",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "getExposedTransportsResponse",
    ...
    public static class Factory{
        ...
        */
        public static GetExposedTransportsResponse parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            GetExposedTransportsResponse object =
                new GetExposedTransportsResponse();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"getExposedTransportsResponse".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (GetExposedTransportsResponse)axis2.apache.org.xsd.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
