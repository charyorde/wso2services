...
/**
 * GetAvgSizeReceivedResponse.java
 *
 ...
 */
            ...
            /**
            *  GetAvgSizeReceivedResponse bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class GetAvgSizeReceivedResponse
        implements org.apache.axis2.databinding.ADBBean{
        
                public static final javax.xml.namespace.QName MY_QNAME = new javax.xml.namespace.QName(
                "http://org.apache.axis2/xsd",
                "getAvgSizeReceivedResponse",
                "ns10");
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":getAvgSizeReceivedResponse",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "getAvgSizeReceivedResponse",
    ...
    public static class Factory{
        ...
        */
        public static GetAvgSizeReceivedResponse parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            GetAvgSizeReceivedResponse object =
                new GetAvgSizeReceivedResponse();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"getAvgSizeReceivedResponse".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (GetAvgSizeReceivedResponse)axis2.apache.org.xsd.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
