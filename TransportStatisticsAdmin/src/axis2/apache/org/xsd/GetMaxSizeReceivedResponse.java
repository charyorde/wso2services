...
/**
 * GetMaxSizeReceivedResponse.java
 *
 ...
 */
            ...
            /**
            *  GetMaxSizeReceivedResponse bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class GetMaxSizeReceivedResponse
        implements org.apache.axis2.databinding.ADBBean{
        
                public static final javax.xml.namespace.QName MY_QNAME = new javax.xml.namespace.QName(
                "http://org.apache.axis2/xsd",
                "getMaxSizeReceivedResponse",
                "ns10");
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":getMaxSizeReceivedResponse",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "getMaxSizeReceivedResponse",
    ...
    public static class Factory{
        ...
        */
        public static GetMaxSizeReceivedResponse parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            GetMaxSizeReceivedResponse object =
                new GetMaxSizeReceivedResponse();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"getMaxSizeReceivedResponse".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (GetMaxSizeReceivedResponse)axis2.apache.org.xsd.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
