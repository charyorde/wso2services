...
/**
 * QueryServerUserDataWithTwoORedConditionsForServerDistinct.java
 *
 ...
 */
            ...
            /**
            *  QueryServerUserDataWithTwoORedConditionsForServerDistinct bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class QueryServerUserDataWithTwoORedConditionsForServerDistinct
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":queryServerUserDataWithTwoORedConditionsForServerDistinct",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "queryServerUserDataWithTwoORedConditionsForServerDistinct",
    ...
    public static class Factory{
        ...
        */
        public static QueryServerUserDataWithTwoORedConditionsForServerDistinct parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            QueryServerUserDataWithTwoORedConditionsForServerDistinct object =
                new QueryServerUserDataWithTwoORedConditionsForServerDistinct();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"queryServerUserDataWithTwoORedConditionsForServerDistinct".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (QueryServerUserDataWithTwoORedConditionsForServerDistinct)org.wso2.carbon.bam.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
