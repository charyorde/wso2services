...
/**
 * QueryServerUserDataWithThreeORedConditionsForServerDistinct.java
 *
 ...
 */
            ...
            /**
            *  QueryServerUserDataWithThreeORedConditionsForServerDistinct bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class QueryServerUserDataWithThreeORedConditionsForServerDistinct
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":queryServerUserDataWithThreeORedConditionsForServerDistinct",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "queryServerUserDataWithThreeORedConditionsForServerDistinct",
    ...
    public static class Factory{
        ...
        */
        public static QueryServerUserDataWithThreeORedConditionsForServerDistinct parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            QueryServerUserDataWithThreeORedConditionsForServerDistinct object =
                new QueryServerUserDataWithThreeORedConditionsForServerDistinct();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"queryServerUserDataWithThreeORedConditionsForServerDistinct".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (QueryServerUserDataWithThreeORedConditionsForServerDistinct)org.wso2.carbon.bam.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
