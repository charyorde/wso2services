...
/**
 * QueryServerUserDataWithThreeORedConditionsForServer.java
 *
 ...
 */
            ...
            /**
            *  QueryServerUserDataWithThreeORedConditionsForServer bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class QueryServerUserDataWithThreeORedConditionsForServer
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":queryServerUserDataWithThreeORedConditionsForServer",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "queryServerUserDataWithThreeORedConditionsForServer",
    ...
    public static class Factory{
        ...
        */
        public static QueryServerUserDataWithThreeORedConditionsForServer parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            QueryServerUserDataWithThreeORedConditionsForServer object =
                new QueryServerUserDataWithThreeORedConditionsForServer();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"queryServerUserDataWithThreeORedConditionsForServer".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (QueryServerUserDataWithThreeORedConditionsForServer)org.wso2.carbon.bam.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
