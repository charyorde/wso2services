...
/**
 * ServiceStatPublisherAdminMessageReceiverRobustInOnly.java
 *
 ...
 */
        ...
        /**
        *  ServiceStatPublisherAdminMessageReceiverRobustInOnly message receiver
        */

        public class ServiceStatPublisherAdminMessageReceiverRobustInOnly extends org.apache.axis2.receivers.AbstractMessageReceiver{
        ...
        if((op.getName() != null) && ((methodName = org.apache.axis2.util.JavaUtils.xmlNameToJavaIdentifier(op.getName().getLocalPart())) != null)){
            ...
            if("configureEventing".equals(methodName)){
            
            
                            //doc style
                            axis2.apache.org.xsd.ConfigureEventing wrappedParam =
                                                         (axis2.apache.org.xsd.ConfigureEventing)fromOM(
                                                        msgContext.getEnvelope().getBody().getFirstElement(),
                                                        axis2.apache.org.xsd.ConfigureEventing.class,
                                                        getEnvelopeNamespaces(msgContext.getEnvelope()));
                                            
                                           
                                                     skel.configureEventing(wrappedParam) ;
        ...
        } catch (ServiceStatPublisherAdminException e) {
            msgContext.setProperty(org.apache.axis2.Constants.FAULT_NAME,"ServiceStatPublisherAdminException");
