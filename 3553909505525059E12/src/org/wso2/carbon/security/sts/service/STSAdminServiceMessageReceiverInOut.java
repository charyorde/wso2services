...
/**
 * STSAdminServiceMessageReceiverInOut.java
 *
 ...
 */
        ...
        /**
        *  STSAdminServiceMessageReceiverInOut message receiver
        */

        public class STSAdminServiceMessageReceiverInOut extends org.apache.axis2.receivers.AbstractInOutMessageReceiver{
        ...
        if((op.getName() != null) && ((methodName = org.apache.axis2.util.JavaUtils.xmlNameToJavaIdentifier(op.getName().getLocalPart())) != null)){
            ...
            if("getProofKeyType".equals(methodName)){
                
                org.wso2.carbon.security.sts.service.GetProofKeyTypeResponse getProofKeyTypeResponse10 = null;
	                        org.wso2.carbon.security.sts.service.GetProofKeyType wrappedParam =
                                                             (org.wso2.carbon.security.sts.service.GetProofKeyType)fromOM(
                                    msgContext.getEnvelope().getBody().getFirstElement(),
                                    org.wso2.carbon.security.sts.service.GetProofKeyType.class,
                                    getEnvelopeNamespaces(msgContext.getEnvelope()));
                                                
                                               getProofKeyTypeResponse10 =
                                                   
                                                   
                                                         skel.getProofKeyType(wrappedParam)
                                                    ;
                                            
                                        envelope = toEnvelope(getSOAPFactory(msgContext), getProofKeyTypeResponse10, false, new javax.xml.namespace.QName("http://service.sts.security.carbon.wso2.org",
                                                    "getProofKeyType"));
                                    } else 

            if("getCertAliasOfPrimaryKeyStore".equals(methodName)){
                
                org.wso2.carbon.security.sts.service.GetCertAliasOfPrimaryKeyStoreResponse getCertAliasOfPrimaryKeyStoreResponse12 = null;
	                        org.wso2.carbon.security.sts.service.GetCertAliasOfPrimaryKeyStore wrappedParam =
                                                             (org.wso2.carbon.security.sts.service.GetCertAliasOfPrimaryKeyStore)fromOM(
                                    msgContext.getEnvelope().getBody().getFirstElement(),
                                    org.wso2.carbon.security.sts.service.GetCertAliasOfPrimaryKeyStore.class,
                                    getEnvelopeNamespaces(msgContext.getEnvelope()));
                                                
                                               getCertAliasOfPrimaryKeyStoreResponse12 =
                                                   
                                                   
                                                         skel.getCertAliasOfPrimaryKeyStore(wrappedParam)
                                                    ;
                                            
                                        envelope = toEnvelope(getSOAPFactory(msgContext), getCertAliasOfPrimaryKeyStoreResponse12, false, new javax.xml.namespace.QName("http://service.sts.security.carbon.wso2.org",
                                                    "getCertAliasOfPrimaryKeyStore"));
                                    } else 

            if("getTrustedServices".equals(methodName)){
                
                org.wso2.carbon.security.sts.service.GetTrustedServicesResponse getTrustedServicesResponse14 = null;
	                        org.wso2.carbon.security.sts.service.GetTrustedServices wrappedParam =
                                                             (org.wso2.carbon.security.sts.service.GetTrustedServices)fromOM(
                                    msgContext.getEnvelope().getBody().getFirstElement(),
                                    org.wso2.carbon.security.sts.service.GetTrustedServices.class,
                                    getEnvelopeNamespaces(msgContext.getEnvelope()));
                                                
                                               getTrustedServicesResponse14 =
                                                   
                                                   
                                                         skel.getTrustedServices(wrappedParam)
                                                    ;
                                            
                                        envelope = toEnvelope(getSOAPFactory(msgContext), getTrustedServicesResponse14, false, new javax.xml.namespace.QName("http://service.sts.security.carbon.wso2.org",
                                                    "getTrustedServices"));
