 ...
 */
    ...
    public static class Factory{
        ...
        */
        public static UploadSample parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            UploadSample object =
                new UploadSample();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"uploadSample".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (UploadSample)org.wso2.carbon.sample.installer.beans.xsd.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
