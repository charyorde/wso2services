 ...
 */
            ...
            /**
            *  DeactivateServer bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class DeactivateServer
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":deactivateServer",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "deactivateServer",
    ...
    public static class Factory{
        ...
        */
        public static DeactivateServer parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            DeactivateServer object =
                new DeactivateServer();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"deactivateServer".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (DeactivateServer)org.wso2.carbon.bam.common.dataobjects.service.xsd.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
