...
/**
 * ListOperationPhasesResponse.java
 *
 ...
 */
            ...
            /**
            *  ListOperationPhasesResponse bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class ListOperationPhasesResponse
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":listOperationPhasesResponse",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "listOperationPhasesResponse",
    ...
    public static class Factory{
        ...
        */
        public static ListOperationPhasesResponse parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            ListOperationPhasesResponse object =
                new ListOperationPhasesResponse();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"listOperationPhasesResponse".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (ListOperationPhasesResponse)axis2.apache.org.xsd.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
