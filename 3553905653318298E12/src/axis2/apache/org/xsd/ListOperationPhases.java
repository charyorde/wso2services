 ...
 */
            ...
            /**
            *  ListOperationPhases bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class ListOperationPhases
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":listOperationPhases",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "listOperationPhases",
    ...
    public static class Factory{
        ...
        */
        public static ListOperationPhases parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            ListOperationPhases object =
                new ListOperationPhases();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"listOperationPhases".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (ListOperationPhases)axis2.apache.org.xsd.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
