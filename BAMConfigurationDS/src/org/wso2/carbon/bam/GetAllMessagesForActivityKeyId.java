...
/**
 * GetAllMessagesForActivityKeyId.java
 *
 ...
 */
            ...
            /**
            *  GetAllMessagesForActivityKeyId bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class GetAllMessagesForActivityKeyId
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":getAllMessagesForActivityKeyId",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "getAllMessagesForActivityKeyId",
    ...
    public static class Factory{
        ...
        */
        public static GetAllMessagesForActivityKeyId parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            GetAllMessagesForActivityKeyId object =
                new GetAllMessagesForActivityKeyId();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"getAllMessagesForActivityKeyId".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (GetAllMessagesForActivityKeyId)org.wso2.carbon.bam.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
