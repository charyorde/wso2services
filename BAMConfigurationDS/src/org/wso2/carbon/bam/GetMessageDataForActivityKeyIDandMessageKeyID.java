...
/**
 * GetMessageDataForActivityKeyIDandMessageKeyID.java
 *
 ...
 */
            ...
            /**
            *  GetMessageDataForActivityKeyIDandMessageKeyID bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class GetMessageDataForActivityKeyIDandMessageKeyID
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":getMessageDataForActivityKeyIDandMessageKeyID",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "getMessageDataForActivityKeyIDandMessageKeyID",
    ...
    public static class Factory{
        ...
        */
        public static GetMessageDataForActivityKeyIDandMessageKeyID parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            GetMessageDataForActivityKeyIDandMessageKeyID object =
                new GetMessageDataForActivityKeyIDandMessageKeyID();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"getMessageDataForActivityKeyIDandMessageKeyID".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (GetMessageDataForActivityKeyIDandMessageKeyID)org.wso2.carbon.bam.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
