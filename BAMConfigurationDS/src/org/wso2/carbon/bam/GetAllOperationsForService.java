...
/**
 * GetAllOperationsForService.java
 *
 ...
 */
            ...
            /**
            *  GetAllOperationsForService bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class GetAllOperationsForService
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":getAllOperationsForService",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "getAllOperationsForService",
    ...
    public static class Factory{
        ...
        */
        public static GetAllOperationsForService parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            GetAllOperationsForService object =
                new GetAllOperationsForService();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"getAllOperationsForService".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (GetAllOperationsForService)org.wso2.carbon.bam.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
