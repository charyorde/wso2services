 ...
 */
            ...
            /**
            *  GetTenent bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class GetTenent
    ...
    public static class Factory{
        ...
        */
        public static GetTenent parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            GetTenent object =
                new GetTenent();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"getTenent".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (GetTenent)org.wso2.carbon.bam.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
