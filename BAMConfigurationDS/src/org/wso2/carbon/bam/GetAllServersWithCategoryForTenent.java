...
/**
 * GetAllServersWithCategoryForTenent.java
 *
 ...
 */
            ...
            /**
            *  GetAllServersWithCategoryForTenent bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class GetAllServersWithCategoryForTenent
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":getAllServersWithCategoryForTenent",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "getAllServersWithCategoryForTenent",
    ...
    public static class Factory{
        ...
        */
        public static GetAllServersWithCategoryForTenent parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            GetAllServersWithCategoryForTenent object =
                new GetAllServersWithCategoryForTenent();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"getAllServersWithCategoryForTenent".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (GetAllServersWithCategoryForTenent)org.wso2.carbon.bam.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
