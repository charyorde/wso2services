...
/**
 * QueryServerUserDataWithTwoANDedConditionsForServerDistinct.java
 *
 ...
 */
            ...
            /**
            *  QueryServerUserDataWithTwoANDedConditionsForServerDistinct bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class QueryServerUserDataWithTwoANDedConditionsForServerDistinct
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":queryServerUserDataWithTwoANDedConditionsForServerDistinct",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "queryServerUserDataWithTwoANDedConditionsForServerDistinct",
    ...
    public static class Factory{
        ...
        */
        public static QueryServerUserDataWithTwoANDedConditionsForServerDistinct parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            QueryServerUserDataWithTwoANDedConditionsForServerDistinct object =
                new QueryServerUserDataWithTwoANDedConditionsForServerDistinct();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"queryServerUserDataWithTwoANDedConditionsForServerDistinct".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (QueryServerUserDataWithTwoANDedConditionsForServerDistinct)org.wso2.carbon.bam.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
