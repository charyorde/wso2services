...
/**
 * QueryServerUserDataWithTwoANDedConditionsForServer.java
 *
 ...
 */
            ...
            /**
            *  QueryServerUserDataWithTwoANDedConditionsForServer bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class QueryServerUserDataWithTwoANDedConditionsForServer
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":queryServerUserDataWithTwoANDedConditionsForServer",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "queryServerUserDataWithTwoANDedConditionsForServer",
    ...
    public static class Factory{
        ...
        */
        public static QueryServerUserDataWithTwoANDedConditionsForServer parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            QueryServerUserDataWithTwoANDedConditionsForServer object =
                new QueryServerUserDataWithTwoANDedConditionsForServer();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"queryServerUserDataWithTwoANDedConditionsForServer".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (QueryServerUserDataWithTwoANDedConditionsForServer)org.wso2.carbon.bam.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
