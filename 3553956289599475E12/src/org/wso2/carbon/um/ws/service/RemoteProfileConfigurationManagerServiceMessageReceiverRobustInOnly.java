...
/**
 * RemoteProfileConfigurationManagerServiceMessageReceiverRobustInOnly.java
 *
 ...
 */
        ...
        /**
        *  RemoteProfileConfigurationManagerServiceMessageReceiverRobustInOnly message receiver
        */

        public class RemoteProfileConfigurationManagerServiceMessageReceiverRobustInOnly extends org.apache.axis2.receivers.AbstractMessageReceiver{
        ...
        if((op.getName() != null) && ((methodName = org.apache.axis2.util.JavaUtils.xmlNameToJavaIdentifier(op.getName().getLocalPart())) != null)){
            ...
            if("addProfileConfig".equals(methodName)){
            
            
                            //doc style
                            org.wso2.carbon.um.ws.service.AddProfileConfig wrappedParam =
                                                         (org.wso2.carbon.um.ws.service.AddProfileConfig)fromOM(
                                                        msgContext.getEnvelope().getBody().getFirstElement(),
                                                        org.wso2.carbon.um.ws.service.AddProfileConfig.class,
                                                        getEnvelopeNamespaces(msgContext.getEnvelope()));
                                            
                                           
                                                     skel.addProfileConfig(wrappedParam) ;
                                                

                             envelope = getSOAPFactory(msgContext).getDefaultEnvelope();
                        } else 
            if("updateProfileConfig".equals(methodName)){
            
            
                            //doc style
                            org.wso2.carbon.um.ws.service.UpdateProfileConfig wrappedParam =
                                                         (org.wso2.carbon.um.ws.service.UpdateProfileConfig)fromOM(
                                                        msgContext.getEnvelope().getBody().getFirstElement(),
                                                        org.wso2.carbon.um.ws.service.UpdateProfileConfig.class,
                                                        getEnvelopeNamespaces(msgContext.getEnvelope()));
                                            
                                           
                                                     skel.updateProfileConfig(wrappedParam) ;
                                                

                             envelope = getSOAPFactory(msgContext).getDefaultEnvelope();
                        } else 
            if("deleteProfileConfig".equals(methodName)){
            
            
                            //doc style
                            org.wso2.carbon.um.ws.service.DeleteProfileConfig wrappedParam =
                                                         (org.wso2.carbon.um.ws.service.DeleteProfileConfig)fromOM(
                                                        msgContext.getEnvelope().getBody().getFirstElement(),
                                                        org.wso2.carbon.um.ws.service.DeleteProfileConfig.class,
                                                        getEnvelopeNamespaces(msgContext.getEnvelope()));
                                            
                                           
                                                     skel.deleteProfileConfig(wrappedParam) ;
