...
/**
 * KeyStoreAdminServiceMessageReceiverRobustInOnly.java
 *
 ...
 */
        ...
        /**
        *  KeyStoreAdminServiceMessageReceiverRobustInOnly message receiver
        */

        public class KeyStoreAdminServiceMessageReceiverRobustInOnly extends org.apache.axis2.receivers.AbstractMessageReceiver{
        ...
        if((op.getName() != null) && ((methodName = org.apache.axis2.util.JavaUtils.xmlNameToJavaIdentifier(op.getName().getLocalPart())) != null)){
            ...
            if("addKeyStore".equals(methodName)){
            
            
                            //doc style
                            org.wso2.carbon.security.keystore.service.AddKeyStore wrappedParam =
                                                         (org.wso2.carbon.security.keystore.service.AddKeyStore)fromOM(
                                                        msgContext.getEnvelope().getBody().getFirstElement(),
                                                        org.wso2.carbon.security.keystore.service.AddKeyStore.class,
                                                        getEnvelopeNamespaces(msgContext.getEnvelope()));
                                            
                                           
                                                     skel.addKeyStore(wrappedParam) ;
                                                

                             envelope = getSOAPFactory(msgContext).getDefaultEnvelope();
                        } else 
            if("importCertToStore".equals(methodName)){
            
            
                            //doc style
                            org.wso2.carbon.security.keystore.service.ImportCertToStore wrappedParam =
                                                         (org.wso2.carbon.security.keystore.service.ImportCertToStore)fromOM(
                                                        msgContext.getEnvelope().getBody().getFirstElement(),
                                                        org.wso2.carbon.security.keystore.service.ImportCertToStore.class,
                                                        getEnvelopeNamespaces(msgContext.getEnvelope()));
                                            
                                           
                                                     skel.importCertToStore(wrappedParam) ;
                                                

                             envelope = getSOAPFactory(msgContext).getDefaultEnvelope();
                        } else 
            if("deleteStore".equals(methodName)){
            
            
                            //doc style
                            org.wso2.carbon.security.keystore.service.DeleteStore wrappedParam =
                                                         (org.wso2.carbon.security.keystore.service.DeleteStore)fromOM(
                                                        msgContext.getEnvelope().getBody().getFirstElement(),
                                                        org.wso2.carbon.security.keystore.service.DeleteStore.class,
                                                        getEnvelopeNamespaces(msgContext.getEnvelope()));
                                            
                                           
                                                     skel.deleteStore(wrappedParam) ;
