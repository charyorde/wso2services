...
/**
 * RetrievePaginatedInstanceUsage.java
 *
 ...
 */
            ...
            /**
            *  RetrievePaginatedInstanceUsage bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class RetrievePaginatedInstanceUsage
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":retrievePaginatedInstanceUsage",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "retrievePaginatedInstanceUsage",
    ...
    public static class Factory{
        ...
        */
        public static RetrievePaginatedInstanceUsage parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            RetrievePaginatedInstanceUsage object =
                new RetrievePaginatedInstanceUsage();
            ...
            try {
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"retrievePaginatedInstanceUsage".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (RetrievePaginatedInstanceUsage)org.wso2.carbon.usage.beans.xsd.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
                ...
                java.util.Vector handledAttributes = new java.util.Vector();
                    ...
                    reader.next();
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("http://services.usage.carbon.wso2.org","pageNumber").equals(reader.getName())){
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("http://services.usage.carbon.wso2.org","entriesPerPage").equals(reader.getName())){
