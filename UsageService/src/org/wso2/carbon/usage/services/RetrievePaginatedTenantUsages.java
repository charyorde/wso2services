...
/**
 * RetrievePaginatedTenantUsages.java
 *
 ...
 */
            ...
            /**
            *  RetrievePaginatedTenantUsages bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class RetrievePaginatedTenantUsages
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":retrievePaginatedTenantUsages",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "retrievePaginatedTenantUsages",
    ...
    public static class Factory{
        ...
        */
        public static RetrievePaginatedTenantUsages parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            RetrievePaginatedTenantUsages object =
                new RetrievePaginatedTenantUsages();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"retrievePaginatedTenantUsages".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (RetrievePaginatedTenantUsages)org.wso2.carbon.usage.beans.xsd.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
