 ...
 */
            ...
            /**
            *  PaginatedTenantUsageInfo bean class
            */
        ...
        /* This type was generated from the piece of schema that had
                ...
                */
                        ...
                        */
                        ...
                        /**
                        * field for TenantUsages
                        * This was an Array!
                        */

                        
                                    protected org.wso2.carbon.usage.beans.xsd.TenantUsage[] localTenantUsages ;
                                
                           /*  This tracker boolean wil be used to detect whether the user called the set method
                          *   for this attribute. It will be used to determine whether to include this field
                           *   in the serialized XML
                           */
                           protected boolean localTenantUsagesTracker = false ;

                           public boolean isTenantUsagesSpecified(){
                               return localTenantUsagesTracker;
                           }
                           ...
                           /**
                           * Auto generated getter method
                           * @return org.wso2.carbon.usage.beans.xsd.TenantUsage[]
                           */
                           public  org.wso2.carbon.usage.beans.xsd.TenantUsage[] getTenantUsages(){
                               return localTenantUsages;
                           }
                              ...
                              /**
                               * validate the array for TenantUsages
                               */
                              protected void validateTenantUsages(org.wso2.carbon.usage.beans.xsd.TenantUsage[] param){
                             ...
                             /**
                              * Auto generated setter method
                              * @param param TenantUsages
                              */
                              public void setTenantUsages(org.wso2.carbon.usage.beans.xsd.TenantUsage[] param){
                              
                                   validateTenantUsages(param);

                               localTenantUsagesTracker = true;
                                      
                                      this.localTenantUsages=param;
                              }
                             ...
                             * @param param org.wso2.carbon.usage.beans.xsd.TenantUsage
                             */
                             public void addTenantUsages(org.wso2.carbon.usage.beans.xsd.TenantUsage param){
                                   if (localTenantUsages == null){
                                   localTenantUsages = new org.wso2.carbon.usage.beans.xsd.TenantUsage[]{};
                                   }
                               ...
                               java.util.List list =
                            org.apache.axis2.databinding.utils.ConverterUtil.toList(localTenantUsages);
                               list.add(param);
                               this.localTenantUsages =
                             (org.wso2.carbon.usage.beans.xsd.TenantUsage[])list.toArray(
                            new org.wso2.carbon.usage.beans.xsd.TenantUsage[list.size()]);
         ...
         public void serialize(final javax.xml.namespace.QName parentQName,
            ...
            throws javax.xml.stream.XMLStreamException, org.apache.axis2.databinding.ADBException{
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":PaginatedTenantUsageInfo",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "PaginatedTenantUsageInfo",
                           xmlWriter);
                   }
                ...
                if (localNumberOfPagesTracker){
                                   ...
                                   xmlWriter.writeEndElement();
                             } if (localTenantUsagesTracker){
                                       if (localTenantUsages!=null){
                                            for (int i = 0;i < localTenantUsages.length;i++){
                                                if (localTenantUsages[i] != null){
                                                 localTenantUsages[i].serialize(new javax.xml.namespace.QName("http://beans.usage.carbon.wso2.org/xsd","tenantUsages"),
                                                           xmlWriter);
                                                } else {
                                                   
                                                            writeStartElement(null, "http://beans.usage.carbon.wso2.org/xsd", "tenantUsages", xmlWriter);
                             ...
                             if (localTenantUsages!=null) {
                                 for (int i = 0;i < localTenantUsages.length;i++){
                                    ...
                                    if (localTenantUsages[i] != null){
                                         elementList.add(new javax.xml.namespace.QName("http://beans.usage.carbon.wso2.org/xsd",
                                                                          "tenantUsages"));
                                         elementList.add(localTenantUsages[i]);
                                    } else {
                                        ...
                                        elementList.add(new javax.xml.namespace.QName("http://beans.usage.carbon.wso2.org/xsd",
                                                                          "tenantUsages"));
                                        elementList.add(localTenantUsages);
    ...
    public static class Factory{
        ...
        */
        public static PaginatedTenantUsageInfo parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            PaginatedTenantUsageInfo object =
                new PaginatedTenantUsageInfo();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"PaginatedTenantUsageInfo".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (PaginatedTenantUsageInfo)org.wso2.carbon.usage.beans.xsd.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
                ...
                java.util.Vector handledAttributes = new java.util.Vector();
                    ...
                    reader.next();
                        ...
                        java.util.ArrayList list3 = new java.util.ArrayList();
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("http://beans.usage.carbon.wso2.org/xsd","tenantUsages").equals(reader.getName())){
                                    ...
                                    // Process the array and step past its final element's end.
                                                        ...
                                                        list3.add(org.wso2.carbon.usage.beans.xsd.TenantUsage.Factory.parse(reader));
                                                                }
                                                        ...
                                                        while(!loopDone3){
                                                            ...
                                                            if (reader.isEndElement()){
                                                                ...
                                                                if (new javax.xml.namespace.QName("http://beans.usage.carbon.wso2.org/xsd","tenantUsages").equals(reader.getName())){
                                                        ...
                                                        object.setTenantUsages((org.wso2.carbon.usage.beans.xsd.TenantUsage[])
                                                            org.apache.axis2.databinding.utils.ConverterUtil.convertToArray(
                                                                org.wso2.carbon.usage.beans.xsd.TenantUsage.class,
                                                                list3));
