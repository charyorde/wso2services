 ...
 */
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":TenantDataCapacity",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "TenantDataCapacity",
    ...
    public static class Factory{
        ...
        */
        public static TenantDataCapacity parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            TenantDataCapacity object =
                new TenantDataCapacity();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"TenantDataCapacity".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (TenantDataCapacity)org.wso2.carbon.usage.beans.xsd.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
