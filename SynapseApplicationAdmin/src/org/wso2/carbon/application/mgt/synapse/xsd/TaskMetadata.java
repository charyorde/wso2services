            ...
            try {
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"TaskMetadata".equals(type)){
                                ...
                                return (TaskMetadata)org.wso2.carbon.application.mgt.synapse.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
                ...
                java.util.Vector handledAttributes = new java.util.Vector();
                    ...
                    reader.next();
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("http://synapse.mgt.application.carbon.wso2.org/xsd","groupName").equals(reader.getName())){
