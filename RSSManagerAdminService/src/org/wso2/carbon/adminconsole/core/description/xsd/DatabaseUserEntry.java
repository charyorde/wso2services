 ...
 */
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":DatabaseUserEntry",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "DatabaseUserEntry",
    ...
    public static class Factory{
        ...
        */
        public static DatabaseUserEntry parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            DatabaseUserEntry object =
                new DatabaseUserEntry();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"DatabaseUserEntry".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (DatabaseUserEntry)org.wso2.carbon.adminconsole.core.admin.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
