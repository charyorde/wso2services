...
/**
 * UpdateClaimMappingBehavior.java
 *
 ...
 */
            ...
            /**
            *  UpdateClaimMappingBehavior bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class UpdateClaimMappingBehavior
        implements org.apache.axis2.databinding.ADBBean{
        
                public static final javax.xml.namespace.QName MY_QNAME = new javax.xml.namespace.QName(
                "http://mgt.profiles.carbon.wso2.org",
                "updateClaimMappingBehavior",
                "ns53");
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":updateClaimMappingBehavior",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "updateClaimMappingBehavior",
    ...
    public static class Factory{
        ...
        */
        public static UpdateClaimMappingBehavior parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            UpdateClaimMappingBehavior object =
                new UpdateClaimMappingBehavior();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"updateClaimMappingBehavior".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (UpdateClaimMappingBehavior)org.wso2.carbon.profiles.mgt.dto.xsd.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
                    ...
                    reader.next();
                        ...
                        java.util.ArrayList list2 = new java.util.ArrayList();
                                    ...
                                    // Process the array and step past its final element's end.
                                                        ...
                                                        list2.add(org.wso2.carbon.profiles.mgt.dto.xsd.ClaimConfigurationDTO.Factory.parse(reader));
                                                                }
