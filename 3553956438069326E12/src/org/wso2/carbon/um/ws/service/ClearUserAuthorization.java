 ...
 */
            ...
            /**
            *  ClearUserAuthorization bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class ClearUserAuthorization
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":clearUserAuthorization",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "clearUserAuthorization",
    ...
    public static class Factory{
        ...
        */
        public static ClearUserAuthorization parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            ClearUserAuthorization object =
                new ClearUserAuthorization();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"clearUserAuthorization".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (ClearUserAuthorization)org.wso2.carbon.user.api.xsd.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
