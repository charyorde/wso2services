 ...
 */
            ...
            /**
            *  IsRoleAuthorized bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class IsRoleAuthorized
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":isRoleAuthorized",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "isRoleAuthorized",
    ...
    public static class Factory{
        ...
        */
        public static IsRoleAuthorized parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            IsRoleAuthorized object =
                new IsRoleAuthorized();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"isRoleAuthorized".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (IsRoleAuthorized)org.wso2.carbon.user.api.xsd.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
