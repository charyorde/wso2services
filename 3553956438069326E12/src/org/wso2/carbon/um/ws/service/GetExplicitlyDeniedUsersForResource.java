...
/**
 * GetExplicitlyDeniedUsersForResource.java
 *
 ...
 */
            ...
            /**
            *  GetExplicitlyDeniedUsersForResource bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class GetExplicitlyDeniedUsersForResource
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":getExplicitlyDeniedUsersForResource",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "getExplicitlyDeniedUsersForResource",
    ...
    public static class Factory{
        ...
        */
        public static GetExplicitlyDeniedUsersForResource parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            GetExplicitlyDeniedUsersForResource object =
                new GetExplicitlyDeniedUsersForResource();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"getExplicitlyDeniedUsersForResource".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (GetExplicitlyDeniedUsersForResource)org.wso2.carbon.user.api.xsd.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
