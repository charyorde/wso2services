...
/**
 * IdentitySTSAdminServiceMessageReceiverInOut.java
 *
 ...
 */
        ...
        /**
        *  IdentitySTSAdminServiceMessageReceiverInOut message receiver
        */

        public class IdentitySTSAdminServiceMessageReceiverInOut extends org.apache.axis2.receivers.AbstractInOutMessageReceiver{
        ...
        if((op.getName() != null) && ((methodName = org.apache.axis2.util.JavaUtils.xmlNameToJavaIdentifier(op.getName().getLocalPart())) != null)){
            ...
            if("readCardIssuerConfiguration".equals(methodName)){
                
                axis2.apache.org.xsd.ReadCardIssuerConfigurationResponse readCardIssuerConfigurationResponse4 = null;
	                        axis2.apache.org.xsd.ReadCardIssuerConfiguration wrappedParam =
                                                             (axis2.apache.org.xsd.ReadCardIssuerConfiguration)fromOM(
                                    msgContext.getEnvelope().getBody().getFirstElement(),
                                    axis2.apache.org.xsd.ReadCardIssuerConfiguration.class,
                                    getEnvelopeNamespaces(msgContext.getEnvelope()));
                                                
                                               readCardIssuerConfigurationResponse4 =
                                                   
                                                   
                                                         skel.readCardIssuerConfiguration(wrappedParam)
                                                    ;
                                            
                                        envelope = toEnvelope(getSOAPFactory(msgContext), readCardIssuerConfigurationResponse4, false, new javax.xml.namespace.QName("http://mgt.sts.identity.carbon.wso2.org",
