 ...
 */
        ...
        implements org.apache.axis2.databinding.ADBBean{
                ...
                "http://wsdl2code.carbon.wso2.org",
                "codegen",
                "ns134");
       ...
       public org.apache.axiom.om.OMElement getOMElement (
            ...
            throws javax.xml.stream.XMLStreamException, org.apache.axis2.databinding.ADBException{
                ...
                java.lang.String namespace = null;
                  ...
                  if (serializeType){
                   ...
                   java.lang.String namespacePrefix = registerPrefix(xmlWriter,"http://wsdl2code.carbon.wso2.org");
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":codegen",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "codegen",
                ...
                if (localOptionsTracker){
                             if (localOptions!=null) {
                                   namespace = "http://wsdl2code.carbon.wso2.org";
                                   for (int i = 0;i < localOptions.length;i++){
                                        ...
                                        // write null attribute
                                           writeStartElement(null, "http://wsdl2code.carbon.wso2.org", "options", xmlWriter);
        ...
        private static java.lang.String generatePrefix(java.lang.String namespace) {
            if(namespace.equals("http://wsdl2code.carbon.wso2.org")){
                return "ns134";
            }
                 ...
                 if (localOptionsTracker){
                            if (localOptions!=null){
                                  for (int i = 0;i < localOptions.length;i++){
                                         ...
                                         if (localOptions[i] != null){
                                          elementList.add(new javax.xml.namespace.QName("http://wsdl2code.carbon.wso2.org",
                                                                              "options"));
                                          elementList.add(
    ...
    public static class Factory{
        ...
        */
        public static Codegen parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            Codegen object =
                new Codegen();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"codegen".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (Codegen)org.wso2.carbon.wsdl2code.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
                ...
                java.util.Vector handledAttributes = new java.util.Vector();
                    ...
                    reader.next();
                        ...
                        java.util.ArrayList list1 = new java.util.ArrayList();
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("http://wsdl2code.carbon.wso2.org","options").equals(reader.getName())){
                                    ...
                                    // Process the array and step past its final element's end.
                                            ...
                                            while(!loopDone1){
                                                ...
                                                if (reader.isEndElement()){
                                                    ...
                                                    if (new javax.xml.namespace.QName("http://wsdl2code.carbon.wso2.org","options").equals(reader.getName())){
