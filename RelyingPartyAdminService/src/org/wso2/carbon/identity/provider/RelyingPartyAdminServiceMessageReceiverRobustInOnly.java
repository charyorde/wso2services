...
/**
 * RelyingPartyAdminServiceMessageReceiverRobustInOnly.java
 *
 ...
 */
        ...
        /**
        *  RelyingPartyAdminServiceMessageReceiverRobustInOnly message receiver
        */

        public class RelyingPartyAdminServiceMessageReceiverRobustInOnly extends org.apache.axis2.receivers.AbstractMessageReceiver{
        ...
        if((op.getName() != null) && ((methodName = org.apache.axis2.util.JavaUtils.xmlNameToJavaIdentifier(op.getName().getLocalPart())) != null)){
            ...
            if("removeUserTrustedRelyingParty".equals(methodName)){
            
            
                            //doc style
                            axis2.apache.org.xsd.RemoveUserTrustedRelyingParty wrappedParam =
                                                         (axis2.apache.org.xsd.RemoveUserTrustedRelyingParty)fromOM(
                                                        msgContext.getEnvelope().getBody().getFirstElement(),
                                                        axis2.apache.org.xsd.RemoveUserTrustedRelyingParty.class,
                                                        getEnvelopeNamespaces(msgContext.getEnvelope()));
                                            
                                           
                                                     skel.removeUserTrustedRelyingParty(wrappedParam) ;
                                                

                             envelope = getSOAPFactory(msgContext).getDefaultEnvelope();
                        } else 
            if("createUserTrustedRP".equals(methodName)){
            
            
                            //doc style
                            axis2.apache.org.xsd.CreateUserTrustedRP wrappedParam =
                                                         (axis2.apache.org.xsd.CreateUserTrustedRP)fromOM(
                                                        msgContext.getEnvelope().getBody().getFirstElement(),
                                                        axis2.apache.org.xsd.CreateUserTrustedRP.class,
                                                        getEnvelopeNamespaces(msgContext.getEnvelope()));
                                            
                                           
                                                     skel.createUserTrustedRP(wrappedParam) ;
