...
/**
 * UpgradeServiceMessageReceiverInOut.java
 *
 ...
 */
        ...
        /**
        *  UpgradeServiceMessageReceiverInOut message receiver
        */

        public class UpgradeServiceMessageReceiverInOut extends org.apache.axis2.receivers.AbstractInOutMessageReceiver{
        ...
        if((op.getName() != null) && ((methodName = org.apache.axis2.util.JavaUtils.xmlNameToJavaIdentifier(op.getName().getLocalPart())) != null)){
            ...
            if("getCurrentSubscription".equals(methodName)){
                
                org.wso2.carbon.upgrade.services.GetCurrentSubscriptionResponse getCurrentSubscriptionResponse7 = null;
	                        org.wso2.carbon.upgrade.services.GetCurrentSubscription wrappedParam =
                                                             (org.wso2.carbon.upgrade.services.GetCurrentSubscription)fromOM(
                                    msgContext.getEnvelope().getBody().getFirstElement(),
                                    org.wso2.carbon.upgrade.services.GetCurrentSubscription.class,
                                    getEnvelopeNamespaces(msgContext.getEnvelope()));
                                                
                                               getCurrentSubscriptionResponse7 =
                                                   
                                                   
                                                         skel.getCurrentSubscription(wrappedParam)
                                                    ;
                                            
                                        envelope = toEnvelope(getSOAPFactory(msgContext), getCurrentSubscriptionResponse7, false, new javax.xml.namespace.QName("http://services.upgrade.carbon.wso2.org",
                                                    "getCurrentSubscription"));
                                    } else 

            if("getPackageInfo".equals(methodName)){
                
                org.wso2.carbon.upgrade.services.GetPackageInfoResponse getPackageInfoResponse9 = null;
	                        org.wso2.carbon.upgrade.services.GetPackageInfo wrappedParam =
                                                             (org.wso2.carbon.upgrade.services.GetPackageInfo)fromOM(
                                    msgContext.getEnvelope().getBody().getFirstElement(),
                                    org.wso2.carbon.upgrade.services.GetPackageInfo.class,
                                    getEnvelopeNamespaces(msgContext.getEnvelope()));
                                                
                                               getPackageInfoResponse9 =
                                                   
                                                   
                                                         skel.getPackageInfo(wrappedParam)
                                                    ;
                                            
                                        envelope = toEnvelope(getSOAPFactory(msgContext), getPackageInfoResponse9, false, new javax.xml.namespace.QName("http://services.upgrade.carbon.wso2.org",
                                                    "getPackageInfo"));
