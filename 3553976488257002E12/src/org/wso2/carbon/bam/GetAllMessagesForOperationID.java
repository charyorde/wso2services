...
/**
 * GetAllMessagesForOperationID.java
 *
 ...
 */
            ...
            /**
            *  GetAllMessagesForOperationID bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class GetAllMessagesForOperationID
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":getAllMessagesForOperationID",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "getAllMessagesForOperationID",
    ...
    public static class Factory{
        ...
        */
        public static GetAllMessagesForOperationID parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            GetAllMessagesForOperationID object =
                new GetAllMessagesForOperationID();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"getAllMessagesForOperationID".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (GetAllMessagesForOperationID)org.wso2.carbon.bam.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
