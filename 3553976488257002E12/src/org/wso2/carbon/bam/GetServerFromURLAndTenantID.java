...
/**
 * GetServerFromURLAndTenantID.java
 *
 ...
 */
            ...
            /**
            *  GetServerFromURLAndTenantID bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class GetServerFromURLAndTenantID
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":getServerFromURLAndTenantID",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "getServerFromURLAndTenantID",
    ...
    public static class Factory{
        ...
        */
        public static GetServerFromURLAndTenantID parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            GetServerFromURLAndTenantID object =
                new GetServerFromURLAndTenantID();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"getServerFromURLAndTenantID".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (GetServerFromURLAndTenantID)org.wso2.carbon.bam.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
