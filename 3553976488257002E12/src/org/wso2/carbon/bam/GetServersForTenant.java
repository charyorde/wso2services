 ...
 */
            ...
            /**
            *  GetServersForTenant bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class GetServersForTenant
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":getServersForTenant",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "getServersForTenant",
    ...
    public static class Factory{
        ...
        */
        public static GetServersForTenant parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            GetServersForTenant object =
                new GetServersForTenant();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"getServersForTenant".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (GetServersForTenant)org.wso2.carbon.bam.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
