 ...
 */
            ...
            /**
            *  GetActivityForActivityID bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class GetActivityForActivityID
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":getActivityForActivityID",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "getActivityForActivityID",
    ...
    public static class Factory{
        ...
        */
        public static GetActivityForActivityID parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            GetActivityForActivityID object =
                new GetActivityForActivityID();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"getActivityForActivityID".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (GetActivityForActivityID)org.wso2.carbon.bam.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
