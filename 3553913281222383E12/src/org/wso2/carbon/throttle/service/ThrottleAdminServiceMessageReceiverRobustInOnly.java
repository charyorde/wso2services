...
/**
 * ThrottleAdminServiceMessageReceiverRobustInOnly.java
 *
 ...
 */
        ...
        /**
        *  ThrottleAdminServiceMessageReceiverRobustInOnly message receiver
        */

        public class ThrottleAdminServiceMessageReceiverRobustInOnly extends org.apache.axis2.receivers.AbstractMessageReceiver{
        ...
        if((op.getName() != null) && ((methodName = org.apache.axis2.util.JavaUtils.xmlNameToJavaIdentifier(op.getName().getLocalPart())) != null)){
            ...
            if("enableThrottling".equals(methodName)){
            
            
                            //doc style
                            org.wso2.carbon.throttle.service.EnableThrottling wrappedParam =
                                                         (org.wso2.carbon.throttle.service.EnableThrottling)fromOM(
                                                        msgContext.getEnvelope().getBody().getFirstElement(),
                                                        org.wso2.carbon.throttle.service.EnableThrottling.class,
                                                        getEnvelopeNamespaces(msgContext.getEnvelope()));
                                            
                                           
                                                     skel.enableThrottling(wrappedParam) ;
                                                

                             envelope = getSOAPFactory(msgContext).getDefaultEnvelope();
                        } else 
            if("disableThrottling".equals(methodName)){
            
            
                            //doc style
                            org.wso2.carbon.throttle.service.DisableThrottling wrappedParam =
                                                         (org.wso2.carbon.throttle.service.DisableThrottling)fromOM(
                                                        msgContext.getEnvelope().getBody().getFirstElement(),
                                                        org.wso2.carbon.throttle.service.DisableThrottling.class,
                                                        getEnvelopeNamespaces(msgContext.getEnvelope()));
                                            
                                           
                                                     skel.disableThrottling(wrappedParam) ;
