 ...
 */
            ...
            /**
            *  RemoveServiceProvider bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class RemoveServiceProvider
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":removeServiceProvider",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "removeServiceProvider",
    ...
    public static class Factory{
        ...
        */
        public static RemoveServiceProvider parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            RemoveServiceProvider object =
                new RemoveServiceProvider();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"removeServiceProvider".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (RemoveServiceProvider)axis2.apache.org.xsd.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
