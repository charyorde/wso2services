...
/**
 * ClearAllRoleAuthorization.java
 *
 ...
 */
            ...
            /**
            *  ClearAllRoleAuthorization bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class ClearAllRoleAuthorization
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":clearAllRoleAuthorization",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "clearAllRoleAuthorization",
    ...
    public static class Factory{
        ...
        */
        public static ClearAllRoleAuthorization parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            ClearAllRoleAuthorization object =
                new ClearAllRoleAuthorization();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"clearAllRoleAuthorization".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (ClearAllRoleAuthorization)org.wso2.carbon.user.api.xsd.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
