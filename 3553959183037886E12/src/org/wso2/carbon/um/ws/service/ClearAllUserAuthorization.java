...
/**
 * ClearAllUserAuthorization.java
 *
 ...
 */
            ...
            /**
            *  ClearAllUserAuthorization bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class ClearAllUserAuthorization
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":clearAllUserAuthorization",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "clearAllUserAuthorization",
    ...
    public static class Factory{
        ...
        */
        public static ClearAllUserAuthorization parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            ClearAllUserAuthorization object =
                new ClearAllUserAuthorization();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"clearAllUserAuthorization".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (ClearAllUserAuthorization)org.wso2.carbon.user.api.xsd.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
