...
/**
 * ClearRoleActionOnAllResources.java
 *
 ...
 */
            ...
            /**
            *  ClearRoleActionOnAllResources bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class ClearRoleActionOnAllResources
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":clearRoleActionOnAllResources",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "clearRoleActionOnAllResources",
    ...
    public static class Factory{
        ...
        */
        public static ClearRoleActionOnAllResources parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            ClearRoleActionOnAllResources object =
                new ClearRoleActionOnAllResources();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"clearRoleActionOnAllResources".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (ClearRoleActionOnAllResources)org.wso2.carbon.user.api.xsd.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
