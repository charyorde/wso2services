...
/**
 * ClearResourceAuthorizations.java
 *
 ...
 */
            ...
            /**
            *  ClearResourceAuthorizations bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class ClearResourceAuthorizations
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":clearResourceAuthorizations",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "clearResourceAuthorizations",
    ...
    public static class Factory{
        ...
        */
        public static ClearResourceAuthorizations parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            ClearResourceAuthorizations object =
                new ClearResourceAuthorizations();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"clearResourceAuthorizations".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (ClearResourceAuthorizations)org.wso2.carbon.user.api.xsd.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
