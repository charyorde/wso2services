 ...
 */
            ...
            /**
            *  ClearRoleAuthorization bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class ClearRoleAuthorization
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":clearRoleAuthorization",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "clearRoleAuthorization",
    ...
    public static class Factory{
        ...
        */
        public static ClearRoleAuthorization parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            ClearRoleAuthorization object =
                new ClearRoleAuthorization();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"clearRoleAuthorization".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (ClearRoleAuthorization)org.wso2.carbon.user.api.xsd.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
