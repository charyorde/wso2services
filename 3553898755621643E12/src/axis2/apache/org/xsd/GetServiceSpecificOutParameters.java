...
/**
 * GetServiceSpecificOutParameters.java
 *
 ...
 */
            ...
            /**
            *  GetServiceSpecificOutParameters bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class GetServiceSpecificOutParameters
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":getServiceSpecificOutParameters",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "getServiceSpecificOutParameters",
    ...
    public static class Factory{
        ...
        */
        public static GetServiceSpecificOutParameters parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            GetServiceSpecificOutParameters object =
                new GetServiceSpecificOutParameters();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"getServiceSpecificOutParameters".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (GetServiceSpecificOutParameters)axis2.apache.org.xsd.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
