...
/**
 * GetServiceSpecificInParameters.java
 *
 ...
 */
            ...
            /**
            *  GetServiceSpecificInParameters bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class GetServiceSpecificInParameters
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":getServiceSpecificInParameters",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "getServiceSpecificInParameters",
    ...
    public static class Factory{
        ...
        */
        public static GetServiceSpecificInParameters parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            GetServiceSpecificInParameters object =
                new GetServiceSpecificInParameters();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"getServiceSpecificInParameters".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (GetServiceSpecificInParameters)axis2.apache.org.xsd.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
