 ...
 */
            ...
            /**
            *  GetXpathConfigurations bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class GetXpathConfigurations
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":getXpathConfigurations",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "getXpathConfigurations",
    ...
    public static class Factory{
        ...
        */
        public static GetXpathConfigurations parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            GetXpathConfigurations object =
                new GetXpathConfigurations();
            ...
            try {
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"getXpathConfigurations".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (GetXpathConfigurations)org.wso2.carbon.bam.common.dataobjects.service.xsd.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
                ...
                java.util.Vector handledAttributes = new java.util.Vector();
                    ...
                    reader.next();
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("http://org.apache.axis2/xsd","serverID").equals(reader.getName())){
