...
/**
 * MultitenancyPurchaseOrder.java
 *
 ...
 */
            ...
            /**
            *  MultitenancyPurchaseOrder bean class
            */
        ...
        /* This type was generated from the piece of schema that had
                name = MultitenancyPurchaseOrder
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":MultitenancyPurchaseOrder",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "MultitenancyPurchaseOrder",
                           xmlWriter);
                   }
                                    ...
                                    writeStartElement(null, namespace, "paymentDate", xmlWriter);
                                          ...
                                          if (localPaymentDate==null){
                                              // write the nil attribute
                                                   ...
                                                   xmlWriter.writeCharacters(org.apache.axis2.databinding.utils.ConverterUtil.convertToString(localPaymentDate));
                                ...
                                elementList.add(
                                   org.apache.axis2.databinding.utils.ConverterUtil.convertToString(localId));
                                      ...
                                      elementList.add(new javax.xml.namespace.QName("http://beans.mgt.billing.carbon.wso2.org/xsd",
                                         ...
                                         elementList.add(localPaymentDate==null?null:
                                         org.apache.axis2.databinding.utils.ConverterUtil.convertToString(localPaymentDate));
                                    } if (localTransactionIdTracker){
                                      elementList.add(new javax.xml.namespace.QName("http://beans.mgt.billing.carbon.wso2.org/xsd",
                                                                      "transactionId"));
    ...
    public static class Factory{
        ...
        */
        public static MultitenancyPurchaseOrder parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            MultitenancyPurchaseOrder object =
            ...
            try {
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"MultitenancyPurchaseOrder".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (MultitenancyPurchaseOrder)org.wso2.carbon.billing.mgt.beans.xsd.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
                ...
                java.util.Vector handledAttributes = new java.util.Vector();
                    ...
                    reader.next();
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("http://beans.mgt.billing.carbon.wso2.org/xsd","id").equals(reader.getName())){
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("http://beans.mgt.billing.carbon.wso2.org/xsd","payment").equals(reader.getName())){
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("http://beans.mgt.billing.carbon.wso2.org/xsd","paymentDate").equals(reader.getName())){
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("http://beans.mgt.billing.carbon.wso2.org/xsd","transactionId").equals(reader.getName())){
