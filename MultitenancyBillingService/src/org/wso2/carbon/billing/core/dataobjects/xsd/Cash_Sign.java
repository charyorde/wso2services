 ...
 */
            ...
            /**
            *  Cash_Sign bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class Cash_Sign
    ...
    public static class Factory{
        ...
        */
        public static Cash_Sign parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            Cash_Sign object =
                new Cash_Sign();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"Cash_Sign".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (Cash_Sign)org.wso2.carbon.billing.mgt.beans.xsd.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
