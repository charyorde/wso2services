 ...
 */
            ...
            /**
            *  GetClaimConfigurations bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class GetClaimConfigurations
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":getClaimConfigurations",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "getClaimConfigurations",
    ...
    public static class Factory{
        ...
        */
        public static GetClaimConfigurations parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            GetClaimConfigurations object =
                new GetClaimConfigurations();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"getClaimConfigurations".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (GetClaimConfigurations)org.wso2.carbon.profiles.mgt.dto.xsd.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
