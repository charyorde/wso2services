...
/**
 * GetAllAvailableProfileConfiguraionsForDialect.java
 *
 ...
 */
            ...
            /**
            *  GetAllAvailableProfileConfiguraionsForDialect bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class GetAllAvailableProfileConfiguraionsForDialect
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":getAllAvailableProfileConfiguraionsForDialect",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "getAllAvailableProfileConfiguraionsForDialect",
    ...
    public static class Factory{
        ...
        */
        public static GetAllAvailableProfileConfiguraionsForDialect parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            GetAllAvailableProfileConfiguraionsForDialect object =
                new GetAllAvailableProfileConfiguraionsForDialect();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"getAllAvailableProfileConfiguraionsForDialect".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (GetAllAvailableProfileConfiguraionsForDialect)org.wso2.carbon.profiles.mgt.dto.xsd.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
