                ...
                if (localUserNameTracker){
                             ...
                             if (localRoles!=null) {
                                   ...
                                   for (int i = 0;i < localRoles.length;i++){
                                        ...
                                        // write null attribute
                                           writeStartElement(null, "http://mgt.user.carbon.wso2.org", "roles", xmlWriter);
                                       ...
                                       if (localClaims!=null){
                                            for (int i = 0;i < localClaims.length;i++){
                                                if (localClaims[i] != null){
                                                 localClaims[i].serialize(new javax.xml.namespace.QName("http://mgt.user.carbon.wso2.org","claims"),
                                                           xmlWriter);
                                                } else {
                                                   
                                                            writeStartElement(null, "http://mgt.user.carbon.wso2.org", "claims", xmlWriter);
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"addUser".equals(type)){
                                ...
                                return (AddUser)org.wso2.carbon.user.mgt.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
                ...
                java.util.Vector handledAttributes = new java.util.Vector();
                    ...
                    reader.next();
                        ...
                        java.util.ArrayList list4 = new java.util.ArrayList();
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("http://mgt.user.carbon.wso2.org","password").equals(reader.getName())){
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("http://mgt.user.carbon.wso2.org","roles").equals(reader.getName())){
                                    ...
                                    // Process the array and step past its final element's end.
                                            ...
                                            while(!loopDone3){
                                                ...
                                                if (reader.isEndElement()){
                                                    ...
                                                    if (new javax.xml.namespace.QName("http://mgt.user.carbon.wso2.org","roles").equals(reader.getName())){
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("http://mgt.user.carbon.wso2.org","claims").equals(reader.getName())){
                                    ...
                                    // Process the array and step past its final element's end.
                                                        ...
                                                        while(!loopDone4){
                                                            ...
                                                            if (reader.isEndElement()){
                                                                ...
                                                                if (new javax.xml.namespace.QName("http://mgt.user.carbon.wso2.org","claims").equals(reader.getName())){
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("http://mgt.user.carbon.wso2.org","profileName").equals(reader.getName())){
