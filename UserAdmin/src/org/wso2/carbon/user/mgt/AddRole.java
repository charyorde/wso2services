                ...
                if (localRoleNameTracker){
                             ...
                             if (localPermissions!=null) {
                                   ...
                                   for (int i = 0;i < localPermissions.length;i++){
                                         ...
                                         // write the null attribute
                                        // write null attribute
                                           writeStartElement(null, "http://mgt.user.carbon.wso2.org", "permissions", xmlWriter);
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"addRole".equals(type)){
                                ...
                                return (AddRole)org.wso2.carbon.user.mgt.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
                ...
                java.util.Vector handledAttributes = new java.util.Vector();
                    ...
                    reader.next();
                        ...
                        java.util.ArrayList list3 = new java.util.ArrayList();
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("http://mgt.user.carbon.wso2.org","permissions").equals(reader.getName())){
                                    ...
                                    // Process the array and step past its final element's end.
                                            ...
                                            while(!loopDone3){
                                                ...
                                                if (reader.isEndElement()){
                                                    ...
                                                    if (new javax.xml.namespace.QName("http://mgt.user.carbon.wso2.org","permissions").equals(reader.getName())){
