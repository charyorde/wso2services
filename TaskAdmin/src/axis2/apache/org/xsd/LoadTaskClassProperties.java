 ...
 */
            ...
            /**
            *  LoadTaskClassProperties bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class LoadTaskClassProperties
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":loadTaskClassProperties",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "loadTaskClassProperties",
    ...
    public static class Factory{
        ...
        */
        public static LoadTaskClassProperties parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            LoadTaskClassProperties object =
                new LoadTaskClassProperties();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"loadTaskClassProperties".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (LoadTaskClassProperties)axis2.apache.org.xsd.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
