...
/**
 * GetHourlyServiceRequestStats.java
 *
 ...
 */
            ...
            /**
            *  GetHourlyServiceRequestStats bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class GetHourlyServiceRequestStats
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":getHourlyServiceRequestStats",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "getHourlyServiceRequestStats",
    ...
    public static class Factory{
        ...
        */
        public static GetHourlyServiceRequestStats parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            GetHourlyServiceRequestStats object =
                new GetHourlyServiceRequestStats();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"getHourlyServiceRequestStats".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (GetHourlyServiceRequestStats)org.wso2.carbon.bam.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
