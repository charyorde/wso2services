 ...
 */
            ...
            /**
            *  GetBandwidthStats bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class GetBandwidthStats
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":getBandwidthStats",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "getBandwidthStats",
    ...
    public static class Factory{
        ...
        */
        public static GetBandwidthStats parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            GetBandwidthStats object =
                new GetBandwidthStats();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"getBandwidthStats".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (GetBandwidthStats)org.wso2.carbon.bam.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
