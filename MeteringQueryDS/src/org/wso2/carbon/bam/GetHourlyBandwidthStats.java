 ...
 */
            ...
            /**
            *  GetHourlyBandwidthStats bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class GetHourlyBandwidthStats
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":getHourlyBandwidthStats",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "getHourlyBandwidthStats",
    ...
    public static class Factory{
        ...
        */
        public static GetHourlyBandwidthStats parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            GetHourlyBandwidthStats object =
                new GetHourlyBandwidthStats();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"getHourlyBandwidthStats".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (GetHourlyBandwidthStats)org.wso2.carbon.bam.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
