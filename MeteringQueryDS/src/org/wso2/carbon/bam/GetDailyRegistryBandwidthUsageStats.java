...
/**
 * GetDailyRegistryBandwidthUsageStats.java
 *
 ...
 */
            ...
            /**
            *  GetDailyRegistryBandwidthUsageStats bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class GetDailyRegistryBandwidthUsageStats
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":getDailyRegistryBandwidthUsageStats",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "getDailyRegistryBandwidthUsageStats",
    ...
    public static class Factory{
        ...
        */
        public static GetDailyRegistryBandwidthUsageStats parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            GetDailyRegistryBandwidthUsageStats object =
                new GetDailyRegistryBandwidthUsageStats();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"getDailyRegistryBandwidthUsageStats".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (GetDailyRegistryBandwidthUsageStats)org.wso2.carbon.bam.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
