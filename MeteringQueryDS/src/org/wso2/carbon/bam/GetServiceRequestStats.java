 ...
 */
            ...
            /**
            *  GetServiceRequestStats bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class GetServiceRequestStats
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":getServiceRequestStats",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "getServiceRequestStats",
    ...
    public static class Factory{
        ...
        */
        public static GetServiceRequestStats parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            GetServiceRequestStats object =
                new GetServiceRequestStats();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"getServiceRequestStats".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (GetServiceRequestStats)org.wso2.carbon.bam.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
