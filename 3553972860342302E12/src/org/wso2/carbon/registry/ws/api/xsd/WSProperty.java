 ...
 */
                ...
                if (localKeyTracker){
                             ...
                             if (localValues!=null) {
                                   ...
                                   for (int i = 0;i < localValues.length;i++){
                                        ...
                                        // write null attribute
                                           writeStartElement(null, "http://api.ws.registry.carbon.wso2.org/xsd", "values", xmlWriter);
    ...
    public static class Factory{
        ...
        */
        public static WSProperty parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            WSProperty object =
                new WSProperty();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"WSProperty".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (WSProperty)org.wso2.carbon.registry.ws.api.xsd.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
                ...
                java.util.Vector handledAttributes = new java.util.Vector();
                    ...
                    reader.next();
                        ...
                        java.util.ArrayList list2 = new java.util.ArrayList();
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("http://api.ws.registry.carbon.wso2.org/xsd","key").equals(reader.getName())){
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("http://api.ws.registry.carbon.wso2.org/xsd","values").equals(reader.getName())){
                                    ...
                                    // Process the array and step past its final element's end.
                                            ...
                                            while(!loopDone2){
                                                ...
                                                if (reader.isEndElement()){
                                                    ...
                                                    if (new javax.xml.namespace.QName("http://api.ws.registry.carbon.wso2.org/xsd","values").equals(reader.getName())){
