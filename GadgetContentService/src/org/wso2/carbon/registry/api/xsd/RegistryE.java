 ...
 */
         ...
         public void serialize(final javax.xml.namespace.QName parentQName,
            ...
            throws javax.xml.stream.XMLStreamException, org.apache.axis2.databinding.ADBException{
                ...
                if (localAvailableAspectsTracker){
                             if (localAvailableAspects!=null) {
                                   namespace = "http://api.registry.carbon.wso2.org/xsd";
                                   for (int i = 0;i < localAvailableAspects.length;i++){
                                        ...
                                        // write null attribute
                                           writeStartElement(null, "http://api.registry.carbon.wso2.org/xsd", "availableAspects", xmlWriter);
                 ...
                 if (localAvailableAspectsTracker){
                            if (localAvailableAspects!=null){
                                  for (int i = 0;i < localAvailableAspects.length;i++){
                                         ...
                                         if (localAvailableAspects[i] != null){
                                          elementList.add(new javax.xml.namespace.QName("http://api.registry.carbon.wso2.org/xsd",
                                                                              "availableAspects"));
                                          elementList.add(
    ...
    public static class Factory{
        ...
        */
        public static RegistryE parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            RegistryE object =
                null;
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"Registry".equals(type)){
                                ...
                                return (RegistryE)org.wso2.carbon.registry.core.jdbc.xsd.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
                ...
                java.util.Vector handledAttributes = new java.util.Vector();
                    ...
                    reader.next();
                        ...
                        java.util.ArrayList list1 = new java.util.ArrayList();
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("http://api.registry.carbon.wso2.org/xsd","availableAspects").equals(reader.getName())){
                                    ...
                                    // Process the array and step past its final element's end.
                                            ...
                                            while(!loopDone1){
                                                ...
                                                if (reader.isEndElement()){
                                                    ...
                                                    if (new javax.xml.namespace.QName("http://api.registry.carbon.wso2.org/xsd","availableAspects").equals(reader.getName())){
