...
/**
 * GetLatestFaultCountForService.java
 *
 ...
 */
            ...
            /**
            *  GetLatestFaultCountForService bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class GetLatestFaultCountForService
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":getLatestFaultCountForService",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "getLatestFaultCountForService",
    ...
    public static class Factory{
        ...
        */
        public static GetLatestFaultCountForService parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            GetLatestFaultCountForService object =
                new GetLatestFaultCountForService();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"getLatestFaultCountForService".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (GetLatestFaultCountForService)org.wso2.carbon.bam.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
