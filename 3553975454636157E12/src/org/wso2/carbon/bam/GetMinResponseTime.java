 ...
 */
            ...
            /**
            *  GetMinResponseTime bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class GetMinResponseTime
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":getMinResponseTime",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "getMinResponseTime",
    ...
    public static class Factory{
        ...
        */
        public static GetMinResponseTime parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            GetMinResponseTime object =
                new GetMinResponseTime();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"getMinResponseTime".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (GetMinResponseTime)org.wso2.carbon.bam.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
