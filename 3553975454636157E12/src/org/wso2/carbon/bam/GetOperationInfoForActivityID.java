...
/**
 * GetOperationInfoForActivityID.java
 *
 ...
 */
            ...
            /**
            *  GetOperationInfoForActivityID bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class GetOperationInfoForActivityID
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":getOperationInfoForActivityID",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "getOperationInfoForActivityID",
    ...
    public static class Factory{
        ...
        */
        public static GetOperationInfoForActivityID parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            GetOperationInfoForActivityID object =
                new GetOperationInfoForActivityID();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"getOperationInfoForActivityID".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (GetOperationInfoForActivityID)org.wso2.carbon.bam.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
