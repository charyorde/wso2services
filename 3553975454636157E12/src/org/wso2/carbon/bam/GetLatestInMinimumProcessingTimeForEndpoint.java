...
/**
 * GetLatestInMinimumProcessingTimeForEndpoint.java
 *
 ...
 */
            ...
            /**
            *  GetLatestInMinimumProcessingTimeForEndpoint bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class GetLatestInMinimumProcessingTimeForEndpoint
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":getLatestInMinimumProcessingTimeForEndpoint",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "getLatestInMinimumProcessingTimeForEndpoint",
    ...
    public static class Factory{
        ...
        */
        public static GetLatestInMinimumProcessingTimeForEndpoint parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            GetLatestInMinimumProcessingTimeForEndpoint object =
                new GetLatestInMinimumProcessingTimeForEndpoint();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"getLatestInMinimumProcessingTimeForEndpoint".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (GetLatestInMinimumProcessingTimeForEndpoint)org.wso2.carbon.bam.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
