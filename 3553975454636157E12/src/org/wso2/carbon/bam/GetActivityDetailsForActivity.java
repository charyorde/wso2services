...
/**
 * GetActivityDetailsForActivity.java
 *
 ...
 */
            ...
            /**
            *  GetActivityDetailsForActivity bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class GetActivityDetailsForActivity
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":getActivityDetailsForActivity",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "getActivityDetailsForActivity",
    ...
    public static class Factory{
        ...
        */
        public static GetActivityDetailsForActivity parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            GetActivityDetailsForActivity object =
                new GetActivityDetailsForActivity();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"getActivityDetailsForActivity".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (GetActivityDetailsForActivity)org.wso2.carbon.bam.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
