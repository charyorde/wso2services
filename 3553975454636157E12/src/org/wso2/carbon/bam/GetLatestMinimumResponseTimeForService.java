...
/**
 * GetLatestMinimumResponseTimeForService.java
 *
 ...
 */
            ...
            /**
            *  GetLatestMinimumResponseTimeForService bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class GetLatestMinimumResponseTimeForService
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":getLatestMinimumResponseTimeForService",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "getLatestMinimumResponseTimeForService",
    ...
    public static class Factory{
        ...
        */
        public static GetLatestMinimumResponseTimeForService parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            GetLatestMinimumResponseTimeForService object =
                new GetLatestMinimumResponseTimeForService();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"getLatestMinimumResponseTimeForService".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (GetLatestMinimumResponseTimeForService)org.wso2.carbon.bam.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
