...
/**
 * GetPropertyKeyForActivity.java
 *
 ...
 */
            ...
            /**
            *  GetPropertyKeyForActivity bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class GetPropertyKeyForActivity
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":getPropertyKeyForActivity",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "getPropertyKeyForActivity",
    ...
    public static class Factory{
        ...
        */
        public static GetPropertyKeyForActivity parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            GetPropertyKeyForActivity object =
                new GetPropertyKeyForActivity();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"getPropertyKeyForActivity".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (GetPropertyKeyForActivity)org.wso2.carbon.bam.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
