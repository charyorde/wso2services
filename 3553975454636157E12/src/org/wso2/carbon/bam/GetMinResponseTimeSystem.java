 ...
 */
            ...
            /**
            *  GetMinResponseTimeSystem bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class GetMinResponseTimeSystem
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":getMinResponseTimeSystem",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "getMinResponseTimeSystem",
    ...
    public static class Factory{
        ...
        */
        public static GetMinResponseTimeSystem parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            GetMinResponseTimeSystem object =
                new GetMinResponseTimeSystem();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"getMinResponseTimeSystem".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (GetMinResponseTimeSystem)org.wso2.carbon.bam.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
