...
/**
 * GetAllActivityDataForTimeRange.java
 *
 ...
 */
            ...
            /**
            *  GetAllActivityDataForTimeRange bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class GetAllActivityDataForTimeRange
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":getAllActivityDataForTimeRange",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "getAllActivityDataForTimeRange",
    ...
    public static class Factory{
        ...
        */
        public static GetAllActivityDataForTimeRange parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            GetAllActivityDataForTimeRange object =
                new GetAllActivityDataForTimeRange();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"getAllActivityDataForTimeRange".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (GetAllActivityDataForTimeRange)org.wso2.carbon.bam.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
