...
/**
 * GetOperationIDForMessageID.java
 *
 ...
 */
            ...
            /**
            *  GetOperationIDForMessageID bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class GetOperationIDForMessageID
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":getOperationIDForMessageID",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "getOperationIDForMessageID",
    ...
    public static class Factory{
        ...
        */
        public static GetOperationIDForMessageID parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            GetOperationIDForMessageID object =
                new GetOperationIDForMessageID();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"getOperationIDForMessageID".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (GetOperationIDForMessageID)org.wso2.carbon.bam.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
