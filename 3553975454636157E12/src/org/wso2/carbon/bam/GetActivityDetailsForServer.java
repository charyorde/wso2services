...
/**
 * GetActivityDetailsForServer.java
 *
 ...
 */
            ...
            /**
            *  GetActivityDetailsForServer bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class GetActivityDetailsForServer
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":getActivityDetailsForServer",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "getActivityDetailsForServer",
    ...
    public static class Factory{
        ...
        */
        public static GetActivityDetailsForServer parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            GetActivityDetailsForServer object =
                new GetActivityDetailsForServer();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"getActivityDetailsForServer".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (GetActivityDetailsForServer)org.wso2.carbon.bam.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
