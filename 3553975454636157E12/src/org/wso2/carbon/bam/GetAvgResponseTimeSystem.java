 ...
 */
            ...
            /**
            *  GetAvgResponseTimeSystem bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class GetAvgResponseTimeSystem
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":getAvgResponseTimeSystem",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "getAvgResponseTimeSystem",
    ...
    public static class Factory{
        ...
        */
        public static GetAvgResponseTimeSystem parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            GetAvgResponseTimeSystem object =
                new GetAvgResponseTimeSystem();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"getAvgResponseTimeSystem".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (GetAvgResponseTimeSystem)org.wso2.carbon.bam.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
