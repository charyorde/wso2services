...
/**
 * GetLatestInCumulativeCountForProxy.java
 *
 ...
 */
            ...
            /**
            *  GetLatestInCumulativeCountForProxy bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class GetLatestInCumulativeCountForProxy
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":getLatestInCumulativeCountForProxy",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "getLatestInCumulativeCountForProxy",
    ...
    public static class Factory{
        ...
        */
        public static GetLatestInCumulativeCountForProxy parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            GetLatestInCumulativeCountForProxy object =
                new GetLatestInCumulativeCountForProxy();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"getLatestInCumulativeCountForProxy".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (GetLatestInCumulativeCountForProxy)org.wso2.carbon.bam.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
