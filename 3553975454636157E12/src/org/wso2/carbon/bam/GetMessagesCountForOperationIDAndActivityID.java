...
/**
 * GetMessagesCountForOperationIDAndActivityID.java
 *
 ...
 */
            ...
            /**
            *  GetMessagesCountForOperationIDAndActivityID bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class GetMessagesCountForOperationIDAndActivityID
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":getMessagesCountForOperationIDAndActivityID",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "getMessagesCountForOperationIDAndActivityID",
    ...
    public static class Factory{
        ...
        */
        public static GetMessagesCountForOperationIDAndActivityID parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            GetMessagesCountForOperationIDAndActivityID object =
                new GetMessagesCountForOperationIDAndActivityID();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"getMessagesCountForOperationIDAndActivityID".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (GetMessagesCountForOperationIDAndActivityID)org.wso2.carbon.bam.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
