...
/**
 * GetLatestInCumulativeCountForEndpoint.java
 *
 ...
 */
            ...
            /**
            *  GetLatestInCumulativeCountForEndpoint bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class GetLatestInCumulativeCountForEndpoint
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":getLatestInCumulativeCountForEndpoint",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "getLatestInCumulativeCountForEndpoint",
    ...
    public static class Factory{
        ...
        */
        public static GetLatestInCumulativeCountForEndpoint parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            GetLatestInCumulativeCountForEndpoint object =
                new GetLatestInCumulativeCountForEndpoint();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"getLatestInCumulativeCountForEndpoint".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (GetLatestInCumulativeCountForEndpoint)org.wso2.carbon.bam.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
