...
/**
 * GetLatestInMaximumProcessingTimeForProxy.java
 *
 ...
 */
            ...
            /**
            *  GetLatestInMaximumProcessingTimeForProxy bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class GetLatestInMaximumProcessingTimeForProxy
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":getLatestInMaximumProcessingTimeForProxy",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "getLatestInMaximumProcessingTimeForProxy",
    ...
    public static class Factory{
        ...
        */
        public static GetLatestInMaximumProcessingTimeForProxy parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            GetLatestInMaximumProcessingTimeForProxy object =
                new GetLatestInMaximumProcessingTimeForProxy();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"getLatestInMaximumProcessingTimeForProxy".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (GetLatestInMaximumProcessingTimeForProxy)org.wso2.carbon.bam.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
