 ...
 */
            ...
            /**
            *  GetOriginalFailCount bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class GetOriginalFailCount
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":getOriginalFailCount",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "getOriginalFailCount",
    ...
    public static class Factory{
        ...
        */
        public static GetOriginalFailCount parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            GetOriginalFailCount object =
                new GetOriginalFailCount();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"getOriginalFailCount".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (GetOriginalFailCount)org.wso2.carbon.bam.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
