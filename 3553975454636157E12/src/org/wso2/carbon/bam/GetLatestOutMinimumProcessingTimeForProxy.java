...
/**
 * GetLatestOutMinimumProcessingTimeForProxy.java
 *
 ...
 */
            ...
            /**
            *  GetLatestOutMinimumProcessingTimeForProxy bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class GetLatestOutMinimumProcessingTimeForProxy
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":getLatestOutMinimumProcessingTimeForProxy",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "getLatestOutMinimumProcessingTimeForProxy",
    ...
    public static class Factory{
        ...
        */
        public static GetLatestOutMinimumProcessingTimeForProxy parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            GetLatestOutMinimumProcessingTimeForProxy object =
                new GetLatestOutMinimumProcessingTimeForProxy();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"getLatestOutMinimumProcessingTimeForProxy".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (GetLatestOutMinimumProcessingTimeForProxy)org.wso2.carbon.bam.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
