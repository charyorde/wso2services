...
/**
 * GetLatestResponseCountForOperation.java
 *
 ...
 */
            ...
            /**
            *  GetLatestResponseCountForOperation bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class GetLatestResponseCountForOperation
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":getLatestResponseCountForOperation",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "getLatestResponseCountForOperation",
    ...
    public static class Factory{
        ...
        */
        public static GetLatestResponseCountForOperation parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            GetLatestResponseCountForOperation object =
                new GetLatestResponseCountForOperation();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"getLatestResponseCountForOperation".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (GetLatestResponseCountForOperation)org.wso2.carbon.bam.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
