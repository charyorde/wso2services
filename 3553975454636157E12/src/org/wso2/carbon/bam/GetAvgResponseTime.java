 ...
 */
            ...
            /**
            *  GetAvgResponseTime bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class GetAvgResponseTime
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":getAvgResponseTime",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "getAvgResponseTime",
    ...
    public static class Factory{
        ...
        */
        public static GetAvgResponseTime parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            GetAvgResponseTime object =
                new GetAvgResponseTime();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"getAvgResponseTime".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (GetAvgResponseTime)org.wso2.carbon.bam.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
