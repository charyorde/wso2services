...
/**
 * GetLatestInAverageProcessingTimeForEndpoint.java
 *
 ...
 */
            ...
            /**
            *  GetLatestInAverageProcessingTimeForEndpoint bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class GetLatestInAverageProcessingTimeForEndpoint
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":getLatestInAverageProcessingTimeForEndpoint",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "getLatestInAverageProcessingTimeForEndpoint",
    ...
    public static class Factory{
        ...
        */
        public static GetLatestInAverageProcessingTimeForEndpoint parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            GetLatestInAverageProcessingTimeForEndpoint object =
                new GetLatestInAverageProcessingTimeForEndpoint();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"getLatestInAverageProcessingTimeForEndpoint".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (GetLatestInAverageProcessingTimeForEndpoint)org.wso2.carbon.bam.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
