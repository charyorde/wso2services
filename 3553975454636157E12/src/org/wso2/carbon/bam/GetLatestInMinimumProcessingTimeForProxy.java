...
/**
 * GetLatestInMinimumProcessingTimeForProxy.java
 *
 ...
 */
            ...
            /**
            *  GetLatestInMinimumProcessingTimeForProxy bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class GetLatestInMinimumProcessingTimeForProxy
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":getLatestInMinimumProcessingTimeForProxy",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "getLatestInMinimumProcessingTimeForProxy",
    ...
    public static class Factory{
        ...
        */
        public static GetLatestInMinimumProcessingTimeForProxy parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            GetLatestInMinimumProcessingTimeForProxy object =
                new GetLatestInMinimumProcessingTimeForProxy();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"getLatestInMinimumProcessingTimeForProxy".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (GetLatestInMinimumProcessingTimeForProxy)org.wso2.carbon.bam.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
