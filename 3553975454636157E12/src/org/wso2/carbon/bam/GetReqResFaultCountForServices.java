...
/**
 * GetReqResFaultCountForServices.java
 *
 ...
 */
            ...
            /**
            *  GetReqResFaultCountForServices bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class GetReqResFaultCountForServices
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":getReqResFaultCountForServices",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "getReqResFaultCountForServices",
    ...
    public static class Factory{
        ...
        */
        public static GetReqResFaultCountForServices parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            GetReqResFaultCountForServices object =
                new GetReqResFaultCountForServices();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"getReqResFaultCountForServices".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (GetReqResFaultCountForServices)org.wso2.carbon.bam.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
