...
/**
 * GetLatestMaximumResponseTimeForServer.java
 *
 ...
 */
            ...
            /**
            *  GetLatestMaximumResponseTimeForServer bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class GetLatestMaximumResponseTimeForServer
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":getLatestMaximumResponseTimeForServer",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "getLatestMaximumResponseTimeForServer",
    ...
    public static class Factory{
        ...
        */
        public static GetLatestMaximumResponseTimeForServer parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            GetLatestMaximumResponseTimeForServer object =
                new GetLatestMaximumResponseTimeForServer();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"getLatestMaximumResponseTimeForServer".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (GetLatestMaximumResponseTimeForServer)org.wso2.carbon.bam.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
