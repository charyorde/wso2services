...
/**
 * GetLastMinuteRequestCount.java
 *
 ...
 */
            ...
            /**
            *  GetLastMinuteRequestCount bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class GetLastMinuteRequestCount
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":getLastMinuteRequestCount",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "getLastMinuteRequestCount",
    ...
    public static class Factory{
        ...
        */
        public static GetLastMinuteRequestCount parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            GetLastMinuteRequestCount object =
                new GetLastMinuteRequestCount();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"getLastMinuteRequestCount".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (GetLastMinuteRequestCount)org.wso2.carbon.bam.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
