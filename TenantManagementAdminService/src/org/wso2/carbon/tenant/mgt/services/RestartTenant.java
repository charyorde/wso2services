 ...
 */
            ...
            /**
            *  RestartTenant bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class RestartTenant
    ...
    public static class Factory{
        ...
        */
        public static RestartTenant parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            RestartTenant object =
                new RestartTenant();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"restartTenant".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (RestartTenant)org.wso2.carbon.tenant.mgt.services.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
