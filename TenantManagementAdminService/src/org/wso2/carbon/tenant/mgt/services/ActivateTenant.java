 ...
 */
            ...
            /**
            *  ActivateTenant bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class ActivateTenant
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":activateTenant",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "activateTenant",
    ...
    public static class Factory{
        ...
        */
        public static ActivateTenant parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            ActivateTenant object =
                new ActivateTenant();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"activateTenant".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (ActivateTenant)org.wso2.carbon.tenant.mgt.services.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
