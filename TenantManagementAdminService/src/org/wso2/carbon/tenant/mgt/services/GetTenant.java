 ...
 */
    ...
    public static class Factory{
        ...
        */
        public static GetTenant parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            GetTenant object =
                new GetTenant();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"getTenant".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (GetTenant)org.wso2.carbon.tenant.mgt.services.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
