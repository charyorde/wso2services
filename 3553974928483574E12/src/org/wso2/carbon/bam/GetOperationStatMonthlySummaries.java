...
/**
 * GetOperationStatMonthlySummaries.java
 *
 ...
 */
            ...
            /**
            *  GetOperationStatMonthlySummaries bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class GetOperationStatMonthlySummaries
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":getOperationStatMonthlySummaries",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "getOperationStatMonthlySummaries",
    ...
    public static class Factory{
        ...
        */
        public static GetOperationStatMonthlySummaries parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            GetOperationStatMonthlySummaries object =
                new GetOperationStatMonthlySummaries();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"getOperationStatMonthlySummaries".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (GetOperationStatMonthlySummaries)org.wso2.carbon.bam.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
