...
/**
 * GetOperationStatYearlySummaries.java
 *
 ...
 */
            ...
            /**
            *  GetOperationStatYearlySummaries bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class GetOperationStatYearlySummaries
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":getOperationStatYearlySummaries",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "getOperationStatYearlySummaries",
    ...
    public static class Factory{
        ...
        */
        public static GetOperationStatYearlySummaries parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            GetOperationStatYearlySummaries object =
                new GetOperationStatYearlySummaries();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"getOperationStatYearlySummaries".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (GetOperationStatYearlySummaries)org.wso2.carbon.bam.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
