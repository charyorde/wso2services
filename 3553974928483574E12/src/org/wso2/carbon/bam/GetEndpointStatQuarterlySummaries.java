...
/**
 * GetEndpointStatQuarterlySummaries.java
 *
 ...
 */
            ...
            /**
            *  GetEndpointStatQuarterlySummaries bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class GetEndpointStatQuarterlySummaries
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":getEndpointStatQuarterlySummaries",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "getEndpointStatQuarterlySummaries",
    ...
    public static class Factory{
        ...
        */
        public static GetEndpointStatQuarterlySummaries parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            GetEndpointStatQuarterlySummaries object =
                new GetEndpointStatQuarterlySummaries();
            ...
            try {
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"getEndpointStatQuarterlySummaries".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (GetEndpointStatQuarterlySummaries)org.wso2.carbon.bam.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
                ...
                java.util.Vector handledAttributes = new java.util.Vector();
                    ...
                    reader.next();
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("http://bam.carbon.wso2.org","endpointName").equals(reader.getName())){
