...
/**
 * GetSequenceStatHourlySummaries.java
 *
 ...
 */
            ...
            /**
            *  GetSequenceStatHourlySummaries bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class GetSequenceStatHourlySummaries
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":getSequenceStatHourlySummaries",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "getSequenceStatHourlySummaries",
    ...
    public static class Factory{
        ...
        */
        public static GetSequenceStatHourlySummaries parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            GetSequenceStatHourlySummaries object =
                new GetSequenceStatHourlySummaries();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"getSequenceStatHourlySummaries".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (GetSequenceStatHourlySummaries)org.wso2.carbon.bam.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
