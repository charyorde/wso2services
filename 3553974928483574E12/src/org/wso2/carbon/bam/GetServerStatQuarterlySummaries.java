...
/**
 * GetServerStatQuarterlySummaries.java
 *
 ...
 */
            ...
            /**
            *  GetServerStatQuarterlySummaries bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class GetServerStatQuarterlySummaries
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":getServerStatQuarterlySummaries",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "getServerStatQuarterlySummaries",
    ...
    public static class Factory{
        ...
        */
        public static GetServerStatQuarterlySummaries parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            GetServerStatQuarterlySummaries object =
                new GetServerStatQuarterlySummaries();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"getServerStatQuarterlySummaries".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (GetServerStatQuarterlySummaries)org.wso2.carbon.bam.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
