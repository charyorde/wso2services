...
/**
 * GetOperationStatQuarterlySummaries.java
 *
 ...
 */
            ...
            /**
            *  GetOperationStatQuarterlySummaries bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class GetOperationStatQuarterlySummaries
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":getOperationStatQuarterlySummaries",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "getOperationStatQuarterlySummaries",
    ...
    public static class Factory{
        ...
        */
        public static GetOperationStatQuarterlySummaries parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            GetOperationStatQuarterlySummaries object =
                new GetOperationStatQuarterlySummaries();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"getOperationStatQuarterlySummaries".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (GetOperationStatQuarterlySummaries)org.wso2.carbon.bam.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
