...
/**
 * GetEndpointStatYearlySummaries.java
 *
 ...
 */
            ...
            /**
            *  GetEndpointStatYearlySummaries bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class GetEndpointStatYearlySummaries
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":getEndpointStatYearlySummaries",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "getEndpointStatYearlySummaries",
    ...
    public static class Factory{
        ...
        */
        public static GetEndpointStatYearlySummaries parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            GetEndpointStatYearlySummaries object =
                new GetEndpointStatYearlySummaries();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"getEndpointStatYearlySummaries".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (GetEndpointStatYearlySummaries)org.wso2.carbon.bam.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
