...
/**
 * GetLatestResponseCountForServer.java
 *
 ...
 */
            ...
            /**
            *  GetLatestResponseCountForServer bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class GetLatestResponseCountForServer
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":getLatestResponseCountForServer",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "getLatestResponseCountForServer",
    ...
    public static class Factory{
        ...
        */
        public static GetLatestResponseCountForServer parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            GetLatestResponseCountForServer object =
                new GetLatestResponseCountForServer();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"getLatestResponseCountForServer".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (GetLatestResponseCountForServer)org.wso2.carbon.bam.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
