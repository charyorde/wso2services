...
/**
 * GetLatestResponseCountForService.java
 *
 ...
 */
            ...
            /**
            *  GetLatestResponseCountForService bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class GetLatestResponseCountForService
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":getLatestResponseCountForService",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "getLatestResponseCountForService",
    ...
    public static class Factory{
        ...
        */
        public static GetLatestResponseCountForService parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            GetLatestResponseCountForService object =
                new GetLatestResponseCountForService();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"getLatestResponseCountForService".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (GetLatestResponseCountForService)org.wso2.carbon.bam.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
