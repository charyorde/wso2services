...
/**
 * GetLastMinuteRequestCountSystem.java
 *
 ...
 */
            ...
            /**
            *  GetLastMinuteRequestCountSystem bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class GetLastMinuteRequestCountSystem
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":getLastMinuteRequestCountSystem",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "getLastMinuteRequestCountSystem",
    ...
    public static class Factory{
        ...
        */
        public static GetLastMinuteRequestCountSystem parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            GetLastMinuteRequestCountSystem object =
                new GetLastMinuteRequestCountSystem();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"getLastMinuteRequestCountSystem".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (GetLastMinuteRequestCountSystem)org.wso2.carbon.bam.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
