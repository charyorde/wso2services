...
/**
 * GetAllIpAddressForTimeRange.java
 *
 ...
 */
            ...
            /**
            *  GetAllIpAddressForTimeRange bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class GetAllIpAddressForTimeRange
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":getAllIpAddressForTimeRange",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "getAllIpAddressForTimeRange",
    ...
    public static class Factory{
        ...
        */
        public static GetAllIpAddressForTimeRange parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            GetAllIpAddressForTimeRange object =
                new GetAllIpAddressForTimeRange();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"getAllIpAddressForTimeRange".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (GetAllIpAddressForTimeRange)org.wso2.carbon.bam.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
