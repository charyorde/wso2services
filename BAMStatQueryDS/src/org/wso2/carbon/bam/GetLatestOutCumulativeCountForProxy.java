...
/**
 * GetLatestOutCumulativeCountForProxy.java
 *
 ...
 */
            ...
            /**
            *  GetLatestOutCumulativeCountForProxy bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class GetLatestOutCumulativeCountForProxy
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":getLatestOutCumulativeCountForProxy",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "getLatestOutCumulativeCountForProxy",
    ...
    public static class Factory{
        ...
        */
        public static GetLatestOutCumulativeCountForProxy parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            GetLatestOutCumulativeCountForProxy object =
                new GetLatestOutCumulativeCountForProxy();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"getLatestOutCumulativeCountForProxy".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (GetLatestOutCumulativeCountForProxy)org.wso2.carbon.bam.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
