...
/**
 * GetLatestMaximumResponseTimeForService.java
 *
 ...
 */
            ...
            /**
            *  GetLatestMaximumResponseTimeForService bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class GetLatestMaximumResponseTimeForService
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":getLatestMaximumResponseTimeForService",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "getLatestMaximumResponseTimeForService",
    ...
    public static class Factory{
        ...
        */
        public static GetLatestMaximumResponseTimeForService parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            GetLatestMaximumResponseTimeForService object =
                new GetLatestMaximumResponseTimeForService();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"getLatestMaximumResponseTimeForService".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (GetLatestMaximumResponseTimeForService)org.wso2.carbon.bam.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
