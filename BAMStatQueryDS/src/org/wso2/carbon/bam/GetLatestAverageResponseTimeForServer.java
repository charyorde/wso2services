...
/**
 * GetLatestAverageResponseTimeForServer.java
 *
 ...
 */
            ...
            /**
            *  GetLatestAverageResponseTimeForServer bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class GetLatestAverageResponseTimeForServer
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":getLatestAverageResponseTimeForServer",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "getLatestAverageResponseTimeForServer",
    ...
    public static class Factory{
        ...
        */
        public static GetLatestAverageResponseTimeForServer parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            GetLatestAverageResponseTimeForServer object =
                new GetLatestAverageResponseTimeForServer();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"getLatestAverageResponseTimeForServer".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (GetLatestAverageResponseTimeForServer)org.wso2.carbon.bam.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
