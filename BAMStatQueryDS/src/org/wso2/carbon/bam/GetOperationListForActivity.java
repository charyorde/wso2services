...
/**
 * GetOperationListForActivity.java
 *
 ...
 */
            ...
            /**
            *  GetOperationListForActivity bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class GetOperationListForActivity
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":getOperationListForActivity",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "getOperationListForActivity",
    ...
    public static class Factory{
        ...
        */
        public static GetOperationListForActivity parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            GetOperationListForActivity object =
                new GetOperationListForActivity();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"getOperationListForActivity".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (GetOperationListForActivity)org.wso2.carbon.bam.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
