 ...
 */
            ...
            /**
            *  GetMaxResponseTime bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class GetMaxResponseTime
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":getMaxResponseTime",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "getMaxResponseTime",
    ...
    public static class Factory{
        ...
        */
        public static GetMaxResponseTime parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            GetMaxResponseTime object =
                new GetMaxResponseTime();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"getMaxResponseTime".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (GetMaxResponseTime)org.wso2.carbon.bam.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
