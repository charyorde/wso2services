...
/**
 * GetLatestMaximumResponseTimeForOperation.java
 *
 ...
 */
            ...
            /**
            *  GetLatestMaximumResponseTimeForOperation bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class GetLatestMaximumResponseTimeForOperation
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":getLatestMaximumResponseTimeForOperation",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "getLatestMaximumResponseTimeForOperation",
    ...
    public static class Factory{
        ...
        */
        public static GetLatestMaximumResponseTimeForOperation parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            GetLatestMaximumResponseTimeForOperation object =
                new GetLatestMaximumResponseTimeForOperation();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"getLatestMaximumResponseTimeForOperation".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (GetLatestMaximumResponseTimeForOperation)org.wso2.carbon.bam.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
