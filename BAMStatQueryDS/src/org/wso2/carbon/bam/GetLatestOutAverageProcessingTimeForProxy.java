...
/**
 * GetLatestOutAverageProcessingTimeForProxy.java
 *
 ...
 */
            ...
            /**
            *  GetLatestOutAverageProcessingTimeForProxy bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class GetLatestOutAverageProcessingTimeForProxy
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":getLatestOutAverageProcessingTimeForProxy",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "getLatestOutAverageProcessingTimeForProxy",
    ...
    public static class Factory{
        ...
        */
        public static GetLatestOutAverageProcessingTimeForProxy parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            GetLatestOutAverageProcessingTimeForProxy object =
                new GetLatestOutAverageProcessingTimeForProxy();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"getLatestOutAverageProcessingTimeForProxy".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (GetLatestOutAverageProcessingTimeForProxy)org.wso2.carbon.bam.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
