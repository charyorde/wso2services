...
/**
 * GetLatestInAverageProcessingTimeForProxy.java
 *
 ...
 */
            ...
            /**
            *  GetLatestInAverageProcessingTimeForProxy bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class GetLatestInAverageProcessingTimeForProxy
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":getLatestInAverageProcessingTimeForProxy",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "getLatestInAverageProcessingTimeForProxy",
    ...
    public static class Factory{
        ...
        */
        public static GetLatestInAverageProcessingTimeForProxy parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            GetLatestInAverageProcessingTimeForProxy object =
                new GetLatestInAverageProcessingTimeForProxy();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"getLatestInAverageProcessingTimeForProxy".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (GetLatestInAverageProcessingTimeForProxy)org.wso2.carbon.bam.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
