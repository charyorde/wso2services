...
/**
 * GetLatestInMaximumProcessingTimeForEndpoint.java
 *
 ...
 */
            ...
            /**
            *  GetLatestInMaximumProcessingTimeForEndpoint bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class GetLatestInMaximumProcessingTimeForEndpoint
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":getLatestInMaximumProcessingTimeForEndpoint",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "getLatestInMaximumProcessingTimeForEndpoint",
    ...
    public static class Factory{
        ...
        */
        public static GetLatestInMaximumProcessingTimeForEndpoint parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            GetLatestInMaximumProcessingTimeForEndpoint object =
                new GetLatestInMaximumProcessingTimeForEndpoint();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"getLatestInMaximumProcessingTimeForEndpoint".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (GetLatestInMaximumProcessingTimeForEndpoint)org.wso2.carbon.bam.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
