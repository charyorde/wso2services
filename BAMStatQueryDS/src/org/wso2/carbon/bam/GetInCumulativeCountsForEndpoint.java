...
/**
 * GetInCumulativeCountsForEndpoint.java
 *
 ...
 */
            ...
            /**
            *  GetInCumulativeCountsForEndpoint bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class GetInCumulativeCountsForEndpoint
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":getInCumulativeCountsForEndpoint",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "getInCumulativeCountsForEndpoint",
    ...
    public static class Factory{
        ...
        */
        public static GetInCumulativeCountsForEndpoint parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            GetInCumulativeCountsForEndpoint object =
                new GetInCumulativeCountsForEndpoint();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"getInCumulativeCountsForEndpoint".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (GetInCumulativeCountsForEndpoint)org.wso2.carbon.bam.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
