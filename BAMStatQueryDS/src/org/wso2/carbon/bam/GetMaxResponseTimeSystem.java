 ...
 */
            ...
            /**
            *  GetMaxResponseTimeSystem bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class GetMaxResponseTimeSystem
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":getMaxResponseTimeSystem",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "getMaxResponseTimeSystem",
    ...
    public static class Factory{
        ...
        */
        public static GetMaxResponseTimeSystem parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            GetMaxResponseTimeSystem object =
                new GetMaxResponseTimeSystem();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"getMaxResponseTimeSystem".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (GetMaxResponseTimeSystem)org.wso2.carbon.bam.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
