...
/**
 * GetMessagesForOperationIDAndActivityID.java
 *
 ...
 */
            ...
            /**
            *  GetMessagesForOperationIDAndActivityID bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class GetMessagesForOperationIDAndActivityID
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":getMessagesForOperationIDAndActivityID",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "getMessagesForOperationIDAndActivityID",
    ...
    public static class Factory{
        ...
        */
        public static GetMessagesForOperationIDAndActivityID parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            GetMessagesForOperationIDAndActivityID object =
                new GetMessagesForOperationIDAndActivityID();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"getMessagesForOperationIDAndActivityID".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (GetMessagesForOperationIDAndActivityID)org.wso2.carbon.bam.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
