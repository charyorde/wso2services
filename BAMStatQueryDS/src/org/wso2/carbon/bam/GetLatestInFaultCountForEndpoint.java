...
/**
 * GetLatestInFaultCountForEndpoint.java
 *
 ...
 */
            ...
            /**
            *  GetLatestInFaultCountForEndpoint bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class GetLatestInFaultCountForEndpoint
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":getLatestInFaultCountForEndpoint",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "getLatestInFaultCountForEndpoint",
    ...
    public static class Factory{
        ...
        */
        public static GetLatestInFaultCountForEndpoint parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            GetLatestInFaultCountForEndpoint object =
                new GetLatestInFaultCountForEndpoint();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"getLatestInFaultCountForEndpoint".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (GetLatestInFaultCountForEndpoint)org.wso2.carbon.bam.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
