...
/**
 * GetLatestRequestCountForServer.java
 *
 ...
 */
            ...
            /**
            *  GetLatestRequestCountForServer bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class GetLatestRequestCountForServer
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":getLatestRequestCountForServer",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "getLatestRequestCountForServer",
    ...
    public static class Factory{
        ...
        */
        public static GetLatestRequestCountForServer parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            GetLatestRequestCountForServer object =
                new GetLatestRequestCountForServer();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"getLatestRequestCountForServer".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (GetLatestRequestCountForServer)org.wso2.carbon.bam.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
