 ...
 */
            ...
            /**
            *  GetAleauditFailCount bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class GetAleauditFailCount
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":getAleauditFailCount",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "getAleauditFailCount",
    ...
    public static class Factory{
        ...
        */
        public static GetAleauditFailCount parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            GetAleauditFailCount object =
                new GetAleauditFailCount();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"getAleauditFailCount".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (GetAleauditFailCount)org.wso2.carbon.bam.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
