...
public class CloudManagerServiceExceptionException extends java.lang.Exception{
    ...
    private static final long serialVersionUID = 1355860525358L;
    
    private org.wso2.stratos.manager.services.mgt.services.CloudManagerServiceException faultMessage;
    ...
    public void setFaultMessage(org.wso2.stratos.manager.services.mgt.services.CloudManagerServiceException msg){
       faultMessage = msg;
    }
    
    public org.wso2.stratos.manager.services.mgt.services.CloudManagerServiceException getFaultMessage(){
       return faultMessage;
    }
}
