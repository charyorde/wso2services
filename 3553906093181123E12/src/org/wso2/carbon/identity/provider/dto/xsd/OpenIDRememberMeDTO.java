 ...
 */
            ...
            /**
            *  OpenIDRememberMeDTO bean class
            */
        ...
        /* This type was generated from the piece of schema that had
                ...
                */
                        ...
                        */
                        ...
                        /**
                        * field for NewCookieValue
                        */

                        
                                    protected java.lang.String localNewCookieValue ;
                                
                           /*  This tracker boolean wil be used to detect whether the user called the set method
                          *   for this attribute. It will be used to determine whether to include this field
                           *   in the serialized XML
                           */
                           protected boolean localNewCookieValueTracker = false ;

                           public boolean isNewCookieValueSpecified(){
                               return localNewCookieValueTracker;
                           }
                           ...
                           */
                           public  java.lang.String getNewCookieValue(){
                               return localNewCookieValue;
                           }
                            ...
                            /**
                               * Auto generated setter method
                               * @param param NewCookieValue
                               */
                               public void setNewCookieValue(java.lang.String param){
                            localNewCookieValueTracker = true;
                                   
                                            this.localNewCookieValue=param;
         ...
         public void serialize(final javax.xml.namespace.QName parentQName,
            ...
            throws javax.xml.stream.XMLStreamException, org.apache.axis2.databinding.ADBException{
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":OpenIDRememberMeDTO",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "OpenIDRememberMeDTO",
                ...
                if (localAuthenticatedTracker){
                             ...
                             } if (localNewCookieValueTracker){
                                    namespace = "http://dto.provider.identity.carbon.wso2.org/xsd";
                                    writeStartElement(null, namespace, "newCookieValue", xmlWriter);
                             

                                          if (localNewCookieValue==null){
                                              // write the nil attribute
                                                   ...
                                                   xmlWriter.writeCharacters(localNewCookieValue);
                                ...
                                elementList.add(
                                   org.apache.axis2.databinding.utils.ConverterUtil.convertToString(localAuthenticated));
                                      ...
                                      elementList.add(new javax.xml.namespace.QName("http://dto.provider.identity.carbon.wso2.org/xsd",
                                         ...
                                         elementList.add(localNewCookieValue==null?null:
                                         org.apache.axis2.databinding.utils.ConverterUtil.convertToString(localNewCookieValue));
                                    }
    ...
    public static class Factory{
        ...
        */
        public static OpenIDRememberMeDTO parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            OpenIDRememberMeDTO object =
                new OpenIDRememberMeDTO();
            ...
            try {
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"OpenIDRememberMeDTO".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (OpenIDRememberMeDTO)axis2.apache.org.xsd.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
                ...
                java.util.Vector handledAttributes = new java.util.Vector();
                    ...
                    reader.next();
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("http://dto.provider.identity.carbon.wso2.org/xsd","newCookieValue").equals(reader.getName())){
