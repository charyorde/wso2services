 ...
 */
            ...
            /**
            *  AuthenticateWithOpenID bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class AuthenticateWithOpenID
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":authenticateWithOpenID",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "authenticateWithOpenID",
    ...
    public static class Factory{
        ...
        */
        public static AuthenticateWithOpenID parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            AuthenticateWithOpenID object =
                new AuthenticateWithOpenID();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"authenticateWithOpenID".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (AuthenticateWithOpenID)axis2.apache.org.xsd.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
