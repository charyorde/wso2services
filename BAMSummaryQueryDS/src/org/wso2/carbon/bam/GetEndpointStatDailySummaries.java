...
/**
 * GetEndpointStatDailySummaries.java
 *
 ...
 */
            ...
            /**
            *  GetEndpointStatDailySummaries bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class GetEndpointStatDailySummaries
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":getEndpointStatDailySummaries",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "getEndpointStatDailySummaries",
    ...
    public static class Factory{
        ...
        */
        public static GetEndpointStatDailySummaries parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            GetEndpointStatDailySummaries object =
                new GetEndpointStatDailySummaries();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"getEndpointStatDailySummaries".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (GetEndpointStatDailySummaries)org.wso2.carbon.bam.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
