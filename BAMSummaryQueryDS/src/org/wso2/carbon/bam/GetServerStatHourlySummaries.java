...
/**
 * GetServerStatHourlySummaries.java
 *
 ...
 */
            ...
            /**
            *  GetServerStatHourlySummaries bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class GetServerStatHourlySummaries
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":getServerStatHourlySummaries",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "getServerStatHourlySummaries",
    ...
    public static class Factory{
        ...
        */
        public static GetServerStatHourlySummaries parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            GetServerStatHourlySummaries object =
                new GetServerStatHourlySummaries();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"getServerStatHourlySummaries".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (GetServerStatHourlySummaries)org.wso2.carbon.bam.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
