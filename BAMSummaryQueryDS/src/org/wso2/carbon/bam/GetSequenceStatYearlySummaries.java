...
/**
 * GetSequenceStatYearlySummaries.java
 *
 ...
 */
            ...
            /**
            *  GetSequenceStatYearlySummaries bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class GetSequenceStatYearlySummaries
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":getSequenceStatYearlySummaries",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "getSequenceStatYearlySummaries",
    ...
    public static class Factory{
        ...
        */
        public static GetSequenceStatYearlySummaries parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            GetSequenceStatYearlySummaries object =
                new GetSequenceStatYearlySummaries();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"getSequenceStatYearlySummaries".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (GetSequenceStatYearlySummaries)org.wso2.carbon.bam.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
