...
/**
 * GetProxyStatQuarterlySummaries.java
 *
 ...
 */
            ...
            /**
            *  GetProxyStatQuarterlySummaries bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class GetProxyStatQuarterlySummaries
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":getProxyStatQuarterlySummaries",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "getProxyStatQuarterlySummaries",
    ...
    public static class Factory{
        ...
        */
        public static GetProxyStatQuarterlySummaries parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            GetProxyStatQuarterlySummaries object =
                new GetProxyStatQuarterlySummaries();
            ...
            try {
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"getProxyStatQuarterlySummaries".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (GetProxyStatQuarterlySummaries)org.wso2.carbon.bam.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
                ...
                java.util.Vector handledAttributes = new java.util.Vector();
                    ...
                    reader.next();
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("http://bam.carbon.wso2.org","proxyName").equals(reader.getName())){
