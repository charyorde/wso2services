...
/**
 * GetSequenceStatMonthlySummaries.java
 *
 ...
 */
            ...
            /**
            *  GetSequenceStatMonthlySummaries bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class GetSequenceStatMonthlySummaries
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":getSequenceStatMonthlySummaries",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "getSequenceStatMonthlySummaries",
    ...
    public static class Factory{
        ...
        */
        public static GetSequenceStatMonthlySummaries parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            GetSequenceStatMonthlySummaries object =
                new GetSequenceStatMonthlySummaries();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"getSequenceStatMonthlySummaries".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (GetSequenceStatMonthlySummaries)org.wso2.carbon.bam.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
