...
/**
 * GetSequenceStatQuarterlySummaries.java
 *
 ...
 */
            ...
            /**
            *  GetSequenceStatQuarterlySummaries bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class GetSequenceStatQuarterlySummaries
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":getSequenceStatQuarterlySummaries",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "getSequenceStatQuarterlySummaries",
    ...
    public static class Factory{
        ...
        */
        public static GetSequenceStatQuarterlySummaries parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            GetSequenceStatQuarterlySummaries object =
                new GetSequenceStatQuarterlySummaries();
            ...
            try {
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"getSequenceStatQuarterlySummaries".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (GetSequenceStatQuarterlySummaries)org.wso2.carbon.bam.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
                ...
                java.util.Vector handledAttributes = new java.util.Vector();
                    ...
                    reader.next();
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("http://bam.carbon.wso2.org","sequenceName").equals(reader.getName())){
