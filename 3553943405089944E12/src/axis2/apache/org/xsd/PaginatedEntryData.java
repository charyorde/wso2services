 ...
 */
            ...
            /**
            *  PaginatedEntryData bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class PaginatedEntryData
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":paginatedEntryData",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "paginatedEntryData",
    ...
    public static class Factory{
        ...
        */
        public static PaginatedEntryData parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            PaginatedEntryData object =
                new PaginatedEntryData();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"paginatedEntryData".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (PaginatedEntryData)axis2.apache.org.xsd.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
