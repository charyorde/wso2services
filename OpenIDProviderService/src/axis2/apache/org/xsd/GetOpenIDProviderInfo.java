 ...
 */
            ...
            /**
            *  GetOpenIDProviderInfo bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class GetOpenIDProviderInfo
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":getOpenIDProviderInfo",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "getOpenIDProviderInfo",
    ...
    public static class Factory{
        ...
        */
        public static GetOpenIDProviderInfo parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            GetOpenIDProviderInfo object =
                new GetOpenIDProviderInfo();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"getOpenIDProviderInfo".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (GetOpenIDProviderInfo)axis2.apache.org.xsd.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
