...
/**
 * ListControlOperationsResponse.java
 *
 ...
 */
            ...
            /**
            *  ListControlOperationsResponse bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class ListControlOperationsResponse
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":listControlOperationsResponse",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "listControlOperationsResponse",
    ...
    public static class Factory{
        ...
        */
        public static ListControlOperationsResponse parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            ListControlOperationsResponse object =
                new ListControlOperationsResponse();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"listControlOperationsResponse".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (ListControlOperationsResponse)axis2.apache.org.xsd.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
