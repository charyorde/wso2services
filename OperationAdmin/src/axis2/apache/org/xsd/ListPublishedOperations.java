 ...
 */
            ...
            /**
            *  ListPublishedOperations bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class ListPublishedOperations
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":listPublishedOperations",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "listPublishedOperations",
    ...
    public static class Factory{
        ...
        */
        public static ListPublishedOperations parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            ListPublishedOperations object =
                new ListPublishedOperations();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"listPublishedOperations".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (ListPublishedOperations)axis2.apache.org.xsd.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
