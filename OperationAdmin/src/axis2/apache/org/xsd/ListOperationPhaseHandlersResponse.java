...
/**
 * ListOperationPhaseHandlersResponse.java
 *
 ...
 */
            ...
            /**
            *  ListOperationPhaseHandlersResponse bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class ListOperationPhaseHandlersResponse
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":listOperationPhaseHandlersResponse",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "listOperationPhaseHandlersResponse",
    ...
    public static class Factory{
        ...
        */
        public static ListOperationPhaseHandlersResponse parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            ListOperationPhaseHandlersResponse object =
                new ListOperationPhaseHandlersResponse();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"listOperationPhaseHandlersResponse".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (ListOperationPhaseHandlersResponse)axis2.apache.org.xsd.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
