 ...
 */
            ...
            /**
            *  ConfigureMTOM bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class ConfigureMTOM
    ...
    public static class Factory{
        ...
        */
        public static ConfigureMTOM parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            ConfigureMTOM object =
                new ConfigureMTOM();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"configureMTOM".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (ConfigureMTOM)axis2.apache.org.xsd.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
