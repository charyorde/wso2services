...
/**
 * GetDeclaredOperationParameters.java
 *
 ...
 */
            ...
            /**
            *  GetDeclaredOperationParameters bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class GetDeclaredOperationParameters
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":getDeclaredOperationParameters",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "getDeclaredOperationParameters",
    ...
    public static class Factory{
        ...
        */
        public static GetDeclaredOperationParameters parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            GetDeclaredOperationParameters object =
                new GetDeclaredOperationParameters();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"getDeclaredOperationParameters".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (GetDeclaredOperationParameters)axis2.apache.org.xsd.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
