 ...
 */
            ...
            /**
            *  ECDetailResponse bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class ECDetailResponse extends org.wso2.carbon.payment.paypal.dto.xsd.ECResponse
        implements org.apache.axis2.databinding.ADBBean{
        /* This type was generated from the piece of schema that had
                name = ECDetailResponse
                ...
                */
                        ...
                        */
                                    ...
                                    protected org.wso2.carbon.payment.paypal.dto.xsd.Address localAddress ;
                          ...
                          *   for this attribute. It will be used to determine whether to include this field
                           ...
                           * @return org.wso2.carbon.payment.paypal.dto.xsd.Address
                           */
                           public  org.wso2.carbon.payment.paypal.dto.xsd.Address getAddress(){
                               return localAddress;
                           }
                            ...
                            /**
                               ...
                               * @param param Address
                               */
                               public void setAddress(org.wso2.carbon.payment.paypal.dto.xsd.Address param){
                        ...
                        */
                                    ...
                                    protected java.lang.String localOrderTotal ;
                           ...
                           */
                           public  java.lang.String getOrderTotal(){
                            ...
                            /**
                               ...
                               */
                               public void setOrderTotal(java.lang.String param){
                            localOrderTotalTracker = true;
                        ...
                        */
                                    ...
                                    protected org.wso2.carbon.payment.paypal.dto.xsd.Payer localPayer ;
                          ...
                          *   for this attribute. It will be used to determine whether to include this field
                           ...
                           */
                           ...
                           /**
                           * Auto generated getter method
                           * @return org.wso2.carbon.payment.paypal.dto.xsd.Payer
                           */
                           public  org.wso2.carbon.payment.paypal.dto.xsd.Payer getPayer(){
                               return localPayer;
                           }
                            ...
                            /**
                               ...
                               * @param param Payer
                               */
                               public void setPayer(org.wso2.carbon.payment.paypal.dto.xsd.Payer param){
                            localPayerTracker = true;
                ...
                java.lang.String namespace = null;
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":ECDetailResponse",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "ECDetailResponse",
                ...
                if (localAckTracker){
                                   ...
                                   xmlWriter.writeEndElement();
                                    ...
                                    if (localAddress==null){
                                        ...
                                        writeStartElement(null, "http://dto.paypal.payment.carbon.wso2.org/xsd", "address", xmlWriter);

                                       // write the nil attribute
                                      writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","nil","1",xmlWriter);
                                      xmlWriter.writeEndElement();
                                    }else{
                                     localAddress.serialize(new javax.xml.namespace.QName("http://dto.paypal.payment.carbon.wso2.org/xsd","address"),
                                        xmlWriter);
                                    }
                                    ...
                                    writeStartElement(null, namespace, "orderTotal", xmlWriter);
                                          ...
                                          if (localOrderTotal==null){
                                              // write the nil attribute
                                                   ...
                                                   xmlWriter.writeCharacters(localOrderTotal);
                                   ...
                                   xmlWriter.writeEndElement();
                                    ...
                                    if (localPayer==null){
                                        ...
                                        writeStartElement(null, "http://dto.paypal.payment.carbon.wso2.org/xsd", "payer", xmlWriter);

                                       // write the nil attribute
                                      writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","nil","1",xmlWriter);
                                      xmlWriter.writeEndElement();
                                    }else{
                                     localPayer.serialize(new javax.xml.namespace.QName("http://dto.paypal.payment.carbon.wso2.org/xsd","payer"),
                                        xmlWriter);
                                    }
                                }
                    xmlWriter.writeEndElement();
        ...
        */
        public javax.xml.stream.XMLStreamReader getPullParser(javax.xml.namespace.QName qName)
                 ...
                 java.util.ArrayList attribList = new java.util.ArrayList();
                    ...
                    attribList.add(new javax.xml.namespace.QName("http://dto.paypal.payment.carbon.wso2.org/xsd","ECDetailResponse"));
                 if (localAckTracker){
                            ...
                            elementList.add(new javax.xml.namespace.QName("http://dto.paypal.payment.carbon.wso2.org/xsd",
                                    ...
                                    localAddress);
                                      ...
                                      elementList.add(new javax.xml.namespace.QName("http://dto.paypal.payment.carbon.wso2.org/xsd",
                                         ...
                                         elementList.add(localOrderTotal==null?null:
                                         org.apache.axis2.databinding.utils.ConverterUtil.convertToString(localOrderTotal));
                                    } if (localPayerTracker){
                            elementList.add(new javax.xml.namespace.QName("http://dto.paypal.payment.carbon.wso2.org/xsd",
                                                                      "payer"));
                            
                            
                                    elementList.add(localPayer==null?null:
                                    localPayer);
                                }
    ...
    public static class Factory{
        ...
        */
        public static ECDetailResponse parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            ECDetailResponse object =
                new ECDetailResponse();
            ...
            try {
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"ECDetailResponse".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (ECDetailResponse)com.paypal.sdk.exceptions.xsd.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
                ...
                java.util.Vector handledAttributes = new java.util.Vector();
                    ...
                    reader.next();
                                      ...
                                      if ("true".equals(nillableValue) || "1".equals(nillableValue)){
                                          ...
                                          reader.next();
                                            ...
                                            reader.next();
                                                ...
                                                object.setAddress(org.wso2.carbon.payment.paypal.dto.xsd.Address.Factory.parse(reader));
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("http://dto.paypal.payment.carbon.wso2.org/xsd","orderTotal").equals(reader.getName())){
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("http://dto.paypal.payment.carbon.wso2.org/xsd","payer").equals(reader.getName())){
                                      ...
                                      if ("true".equals(nillableValue) || "1".equals(nillableValue)){
                                          ...
                                          reader.next();
                                            ...
                                            reader.next();
                                                ...
                                                object.setPayer(org.wso2.carbon.payment.paypal.dto.xsd.Payer.Factory.parse(reader));
