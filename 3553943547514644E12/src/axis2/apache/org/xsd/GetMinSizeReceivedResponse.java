...
/**
 * GetMinSizeReceivedResponse.java
 *
 ...
 */
            ...
            /**
            *  GetMinSizeReceivedResponse bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class GetMinSizeReceivedResponse
        implements org.apache.axis2.databinding.ADBBean{
        
                public static final javax.xml.namespace.QName MY_QNAME = new javax.xml.namespace.QName(
                "http://org.apache.axis2/xsd",
                "getMinSizeReceivedResponse",
                "ns10");
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":getMinSizeReceivedResponse",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "getMinSizeReceivedResponse",
    ...
    public static class Factory{
        ...
        */
        public static GetMinSizeReceivedResponse parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            GetMinSizeReceivedResponse object =
                new GetMinSizeReceivedResponse();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"getMinSizeReceivedResponse".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (GetMinSizeReceivedResponse)axis2.apache.org.xsd.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
