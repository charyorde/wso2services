...
/**
 * GetAllowedRolesForResource.java
 *
 ...
 */
            ...
            /**
            *  GetAllowedRolesForResource bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class GetAllowedRolesForResource
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":getAllowedRolesForResource",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "getAllowedRolesForResource",
    ...
    public static class Factory{
        ...
        */
        public static GetAllowedRolesForResource parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            GetAllowedRolesForResource object =
                new GetAllowedRolesForResource();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"getAllowedRolesForResource".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (GetAllowedRolesForResource)org.wso2.carbon.user.api.xsd.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
