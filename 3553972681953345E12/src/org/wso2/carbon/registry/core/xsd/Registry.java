 ...
 */
                ...
                package org.wso2.carbon.registry.core.xsd;
        ...
        /* This type was generated from the piece of schema that had
                name = Registry
                Namespace URI = http://core.registry.carbon.wso2.org/xsd
                Namespace Prefix = ns94
                */
       ...
       public org.apache.axiom.om.OMElement getOMElement (
            ...
            throws javax.xml.stream.XMLStreamException, org.apache.axis2.databinding.ADBException{
                ...
                java.lang.String namespace = null;
                  ...
                  if (serializeType){
                   ...
                   java.lang.String namespacePrefix = registerPrefix(xmlWriter,"http://core.registry.carbon.wso2.org/xsd");
                ...
                if (localAvailableAspectsTracker){
                             if (localAvailableAspects!=null) {
                                   namespace = "http://core.registry.carbon.wso2.org/xsd";
                                   for (int i = 0;i < localAvailableAspects.length;i++){
                                        ...
                                        // write null attribute
                                           writeStartElement(null, "http://core.registry.carbon.wso2.org/xsd", "availableAspects", xmlWriter);
                                    ...
                                    if (localRegistryContext==null){
                                        ...
                                        writeStartElement(null, "http://core.registry.carbon.wso2.org/xsd", "registryContext", xmlWriter);

                                       // write the nil attribute
                                      writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","nil","1",xmlWriter);
                                      xmlWriter.writeEndElement();
                                    }else{
                                     localRegistryContext.serialize(new javax.xml.namespace.QName("http://core.registry.carbon.wso2.org/xsd","registryContext"),
                                        xmlWriter);
                                    }
                                }
                    xmlWriter.writeEndElement();
        ...
        private static java.lang.String generatePrefix(java.lang.String namespace) {
            if(namespace.equals("http://core.registry.carbon.wso2.org/xsd")){
                return "ns94";
            }
                 ...
                 if (localAvailableAspectsTracker){
                            if (localAvailableAspects!=null){
                                  for (int i = 0;i < localAvailableAspects.length;i++){
                                         ...
                                         if (localAvailableAspects[i] != null){
                                          elementList.add(new javax.xml.namespace.QName("http://core.registry.carbon.wso2.org/xsd",
                                                                              "availableAspects"));
                                          elementList.add(
    ...
    public static class Factory{
        ...
        */
        public static Registry parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            Registry object =
                null;
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"Registry".equals(type)){
                                ...
                                return (Registry)org.wso2.carbon.registry.core.jdbc.xsd.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
                ...
                java.util.Vector handledAttributes = new java.util.Vector();
                    ...
                    reader.next();
                        ...
                        java.util.ArrayList list1 = new java.util.ArrayList();
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("http://core.registry.carbon.wso2.org/xsd","availableAspects").equals(reader.getName())){
                                    ...
                                    // Process the array and step past its final element's end.
                                            ...
                                            while(!loopDone1){
                                                ...
                                                if (reader.isEndElement()){
                                                    ...
                                                    if (new javax.xml.namespace.QName("http://core.registry.carbon.wso2.org/xsd","availableAspects").equals(reader.getName())){
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("http://core.registry.carbon.wso2.org/xsd","registryContext").equals(reader.getName())){
