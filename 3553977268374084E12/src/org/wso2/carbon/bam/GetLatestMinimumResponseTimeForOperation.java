...
/**
 * GetLatestMinimumResponseTimeForOperation.java
 *
 ...
 */
            ...
            /**
            *  GetLatestMinimumResponseTimeForOperation bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class GetLatestMinimumResponseTimeForOperation
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":getLatestMinimumResponseTimeForOperation",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "getLatestMinimumResponseTimeForOperation",
    ...
    public static class Factory{
        ...
        */
        public static GetLatestMinimumResponseTimeForOperation parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            GetLatestMinimumResponseTimeForOperation object =
                new GetLatestMinimumResponseTimeForOperation();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"getLatestMinimumResponseTimeForOperation".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (GetLatestMinimumResponseTimeForOperation)org.wso2.carbon.bam.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
