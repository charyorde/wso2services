...
/**
 * GetClientServiceOperation.java
 *
 ...
 */
            ...
            /**
            *  GetClientServiceOperation bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class GetClientServiceOperation
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":getClientServiceOperation",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "getClientServiceOperation",
    ...
    public static class Factory{
        ...
        */
        public static GetClientServiceOperation parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            GetClientServiceOperation object =
                new GetClientServiceOperation();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"getClientServiceOperation".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (GetClientServiceOperation)org.wso2.carbon.bam.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
