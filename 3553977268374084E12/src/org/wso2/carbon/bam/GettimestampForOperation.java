 ...
 */
            ...
            /**
            *  GettimestampForOperation bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class GettimestampForOperation
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":gettimestampForOperation",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "gettimestampForOperation",
    ...
    public static class Factory{
        ...
        */
        public static GettimestampForOperation parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            GettimestampForOperation object =
                new GettimestampForOperation();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"gettimestampForOperation".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (GettimestampForOperation)org.wso2.carbon.bam.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
