...
/**
 * GetReplayedFailRequestCount.java
 *
 ...
 */
            ...
            /**
            *  GetReplayedFailRequestCount bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class GetReplayedFailRequestCount
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":getReplayedFailRequestCount",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "getReplayedFailRequestCount",
    ...
    public static class Factory{
        ...
        */
        public static GetReplayedFailRequestCount parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            GetReplayedFailRequestCount object =
                new GetReplayedFailRequestCount();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"getReplayedFailRequestCount".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (GetReplayedFailRequestCount)org.wso2.carbon.bam.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
