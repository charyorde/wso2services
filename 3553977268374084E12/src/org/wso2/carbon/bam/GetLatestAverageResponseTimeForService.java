...
/**
 * GetLatestAverageResponseTimeForService.java
 *
 ...
 */
            ...
            /**
            *  GetLatestAverageResponseTimeForService bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class GetLatestAverageResponseTimeForService
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":getLatestAverageResponseTimeForService",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "getLatestAverageResponseTimeForService",
    ...
    public static class Factory{
        ...
        */
        public static GetLatestAverageResponseTimeForService parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            GetLatestAverageResponseTimeForService object =
                new GetLatestAverageResponseTimeForService();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"getLatestAverageResponseTimeForService".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (GetLatestAverageResponseTimeForService)org.wso2.carbon.bam.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
