...
/**
 * GetLatestRequestCountForService.java
 *
 ...
 */
            ...
            /**
            *  GetLatestRequestCountForService bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class GetLatestRequestCountForService
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":getLatestRequestCountForService",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "getLatestRequestCountForService",
    ...
    public static class Factory{
        ...
        */
        public static GetLatestRequestCountForService parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            GetLatestRequestCountForService object =
                new GetLatestRequestCountForService();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"getLatestRequestCountForService".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (GetLatestRequestCountForService)org.wso2.carbon.bam.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
