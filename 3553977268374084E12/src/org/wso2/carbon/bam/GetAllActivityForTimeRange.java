...
/**
 * GetAllActivityForTimeRange.java
 *
 ...
 */
            ...
            /**
            *  GetAllActivityForTimeRange bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class GetAllActivityForTimeRange
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":getAllActivityForTimeRange",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "getAllActivityForTimeRange",
    ...
    public static class Factory{
        ...
        */
        public static GetAllActivityForTimeRange parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            GetAllActivityForTimeRange object =
                new GetAllActivityForTimeRange();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"getAllActivityForTimeRange".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (GetAllActivityForTimeRange)org.wso2.carbon.bam.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
