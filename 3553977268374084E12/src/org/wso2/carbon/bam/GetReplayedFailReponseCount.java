...
/**
 * GetReplayedFailReponseCount.java
 *
 ...
 */
            ...
            /**
            *  GetReplayedFailReponseCount bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class GetReplayedFailReponseCount
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":getReplayedFailReponseCount",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "getReplayedFailReponseCount",
    ...
    public static class Factory{
        ...
        */
        public static GetReplayedFailReponseCount parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            GetReplayedFailReponseCount object =
                new GetReplayedFailReponseCount();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"getReplayedFailReponseCount".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (GetReplayedFailReponseCount)org.wso2.carbon.bam.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
