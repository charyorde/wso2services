...
/**
 * GetCountofChildrenFailedMessages.java
 *
 ...
 */
            ...
            /**
            *  GetCountofChildrenFailedMessages bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class GetCountofChildrenFailedMessages
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":getCountofChildrenFailedMessages",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "getCountofChildrenFailedMessages",
    ...
    public static class Factory{
        ...
        */
        public static GetCountofChildrenFailedMessages parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            GetCountofChildrenFailedMessages object =
                new GetCountofChildrenFailedMessages();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"getCountofChildrenFailedMessages".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (GetCountofChildrenFailedMessages)org.wso2.carbon.bam.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
