...
/**
 * GetAllMessagesForTimeRange.java
 *
 ...
 */
            ...
            /**
            *  GetAllMessagesForTimeRange bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class GetAllMessagesForTimeRange
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":getAllMessagesForTimeRange",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "getAllMessagesForTimeRange",
    ...
    public static class Factory{
        ...
        */
        public static GetAllMessagesForTimeRange parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            GetAllMessagesForTimeRange object =
                new GetAllMessagesForTimeRange();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"getAllMessagesForTimeRange".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (GetAllMessagesForTimeRange)org.wso2.carbon.bam.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
