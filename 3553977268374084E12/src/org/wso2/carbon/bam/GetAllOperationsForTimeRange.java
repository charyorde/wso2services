...
/**
 * GetAllOperationsForTimeRange.java
 *
 ...
 */
            ...
            /**
            *  GetAllOperationsForTimeRange bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class GetAllOperationsForTimeRange
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":getAllOperationsForTimeRange",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "getAllOperationsForTimeRange",
    ...
    public static class Factory{
        ...
        */
        public static GetAllOperationsForTimeRange parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            GetAllOperationsForTimeRange object =
                new GetAllOperationsForTimeRange();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"getAllOperationsForTimeRange".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (GetAllOperationsForTimeRange)org.wso2.carbon.bam.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
