...
/**
 * GetOperationsForOperationID.java
 *
 ...
 */
            ...
            /**
            *  GetOperationsForOperationID bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class GetOperationsForOperationID
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":getOperationsForOperationID",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "getOperationsForOperationID",
    ...
    public static class Factory{
        ...
        */
        public static GetOperationsForOperationID parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            GetOperationsForOperationID object =
                new GetOperationsForOperationID();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"getOperationsForOperationID".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (GetOperationsForOperationID)org.wso2.carbon.bam.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
