...
/**
 * GetServiceListForActivity.java
 *
 ...
 */
            ...
            /**
            *  GetServiceListForActivity bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class GetServiceListForActivity
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":getServiceListForActivity",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "getServiceListForActivity",
    ...
    public static class Factory{
        ...
        */
        public static GetServiceListForActivity parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            GetServiceListForActivity object =
                new GetServiceListForActivity();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"getServiceListForActivity".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (GetServiceListForActivity)org.wso2.carbon.bam.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
