 ...
 */
            ...
            /**
            *  GetMessageForMessageID bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class GetMessageForMessageID
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":getMessageForMessageID",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "getMessageForMessageID",
    ...
    public static class Factory{
        ...
        */
        public static GetMessageForMessageID parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            GetMessageForMessageID object =
                new GetMessageForMessageID();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"getMessageForMessageID".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (GetMessageForMessageID)org.wso2.carbon.bam.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
