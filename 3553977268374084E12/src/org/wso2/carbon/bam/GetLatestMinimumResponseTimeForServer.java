...
/**
 * GetLatestMinimumResponseTimeForServer.java
 *
 ...
 */
            ...
            /**
            *  GetLatestMinimumResponseTimeForServer bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class GetLatestMinimumResponseTimeForServer
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":getLatestMinimumResponseTimeForServer",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "getLatestMinimumResponseTimeForServer",
    ...
    public static class Factory{
        ...
        */
        public static GetLatestMinimumResponseTimeForServer parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            GetLatestMinimumResponseTimeForServer object =
                new GetLatestMinimumResponseTimeForServer();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"getLatestMinimumResponseTimeForServer".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (GetLatestMinimumResponseTimeForServer)org.wso2.carbon.bam.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
