...
/**
 * GetUserClaimValuesForClaims.java
 *
 ...
 */
            ...
            /**
            *  GetUserClaimValuesForClaims bean class
            */
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":getUserClaimValuesForClaims",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "getUserClaimValuesForClaims",
    ...
    public static class Factory{
        ...
        */
        public static GetUserClaimValuesForClaims parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            GetUserClaimValuesForClaims object =
                new GetUserClaimValuesForClaims();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"getUserClaimValuesForClaims".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (GetUserClaimValuesForClaims)org.wso2.carbon.user.api.xsd.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
