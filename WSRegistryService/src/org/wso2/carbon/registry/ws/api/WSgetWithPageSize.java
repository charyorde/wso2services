 ...
 */
            ...
            /**
            *  WSgetWithPageSize bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class WSgetWithPageSize
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":WSgetWithPageSize",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "WSgetWithPageSize",
    ...
    public static class Factory{
        ...
        */
        public static WSgetWithPageSize parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            WSgetWithPageSize object =
                new WSgetWithPageSize();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"WSgetWithPageSize".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (WSgetWithPageSize)org.wso2.carbon.registry.ws.api.xsd.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
