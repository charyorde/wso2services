 ...
 */
            ...
            /**
            *  WSexecuteQuery bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class WSexecuteQuery
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":WSexecuteQuery",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "WSexecuteQuery",
                ...
                if (localPathTracker){
                             ...
                             if (localKey!=null) {
                                   ...
                                   for (int i = 0;i < localKey.length;i++){
                                        ...
                                        // write null attribute
                                           writeStartElement(null, "http://api.ws.registry.carbon.wso2.org", "key", xmlWriter);
                             ...
                             if (localValue!=null) {
                                   ...
                                   for (int i = 0;i < localValue.length;i++){
                                         ...
                                         // write the null attribute
                                        // write null attribute
                                           writeStartElement(null, "http://api.ws.registry.carbon.wso2.org", "value", xmlWriter);
    ...
    public static class Factory{
        ...
        */
        public static WSexecuteQuery parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            WSexecuteQuery object =
                new WSexecuteQuery();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"WSexecuteQuery".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (WSexecuteQuery)org.wso2.carbon.registry.ws.api.xsd.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
                ...
                java.util.Vector handledAttributes = new java.util.Vector();
                    ...
                    reader.next();
                        ...
                        java.util.ArrayList list3 = new java.util.ArrayList();
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("http://api.ws.registry.carbon.wso2.org","key").equals(reader.getName())){
                                    ...
                                    // Process the array and step past its final element's end.
                                            ...
                                            while(!loopDone2){
                                                ...
                                                if (reader.isEndElement()){
                                                    ...
                                                    if (new javax.xml.namespace.QName("http://api.ws.registry.carbon.wso2.org","key").equals(reader.getName())){
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("http://api.ws.registry.carbon.wso2.org","value").equals(reader.getName())){
                                    ...
                                    // Process the array and step past its final element's end.
                                            ...
                                            while(!loopDone3){
                                                ...
                                                if (reader.isEndElement()){
                                                    ...
                                                    if (new javax.xml.namespace.QName("http://api.ws.registry.carbon.wso2.org","value").equals(reader.getName())){
