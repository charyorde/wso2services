...
/**
 * CustomMeteringServiceMessageReceiverRobustInOnly.java
 *
 ...
 */
        ...
        /**
        *  CustomMeteringServiceMessageReceiverRobustInOnly message receiver
        */

        public class CustomMeteringServiceMessageReceiverRobustInOnly extends org.apache.axis2.receivers.AbstractMessageReceiver{
        ...
        if((op.getName() != null) && ((methodName = org.apache.axis2.util.JavaUtils.xmlNameToJavaIdentifier(op.getName().getLocalPart())) != null)){
            ...
            if("persistUsage".equals(methodName)){
            
            
                            //doc style
                            org.wso2.carbon.usage.agent.services.PersistUsage wrappedParam =
                                                         (org.wso2.carbon.usage.agent.services.PersistUsage)fromOM(
                                                        msgContext.getEnvelope().getBody().getFirstElement(),
                                                        org.wso2.carbon.usage.agent.services.PersistUsage.class,
                                                        getEnvelopeNamespaces(msgContext.getEnvelope()));
                                            
                                           
                                                     skel.persistUsage(wrappedParam) ;
