...
/**
 * GetRegistryBandwidthUsage.java
 *
 ...
 */
            ...
            /**
            *  GetRegistryBandwidthUsage bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class GetRegistryBandwidthUsage
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":getRegistryBandwidthUsage",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "getRegistryBandwidthUsage",
    ...
    public static class Factory{
        ...
        */
        public static GetRegistryBandwidthUsage parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            GetRegistryBandwidthUsage object =
                new GetRegistryBandwidthUsage();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"getRegistryBandwidthUsage".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (GetRegistryBandwidthUsage)org.wso2.carbon.bam.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
