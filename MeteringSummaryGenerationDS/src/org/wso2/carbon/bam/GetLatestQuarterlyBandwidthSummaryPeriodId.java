...
/**
 * GetLatestQuarterlyBandwidthSummaryPeriodId.java
 *
 ...
 */
            ...
            /**
            *  GetLatestQuarterlyBandwidthSummaryPeriodId bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class GetLatestQuarterlyBandwidthSummaryPeriodId
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":getLatestQuarterlyBandwidthSummaryPeriodId",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "getLatestQuarterlyBandwidthSummaryPeriodId",
    ...
    public static class Factory{
        ...
        */
        public static GetLatestQuarterlyBandwidthSummaryPeriodId parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            GetLatestQuarterlyBandwidthSummaryPeriodId object =
                new GetLatestQuarterlyBandwidthSummaryPeriodId();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"getLatestQuarterlyBandwidthSummaryPeriodId".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (GetLatestQuarterlyBandwidthSummaryPeriodId)org.wso2.carbon.bam.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
