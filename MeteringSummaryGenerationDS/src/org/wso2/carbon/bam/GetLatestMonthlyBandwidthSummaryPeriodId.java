...
/**
 * GetLatestMonthlyBandwidthSummaryPeriodId.java
 *
 ...
 */
            ...
            /**
            *  GetLatestMonthlyBandwidthSummaryPeriodId bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class GetLatestMonthlyBandwidthSummaryPeriodId
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":getLatestMonthlyBandwidthSummaryPeriodId",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "getLatestMonthlyBandwidthSummaryPeriodId",
    ...
    public static class Factory{
        ...
        */
        public static GetLatestMonthlyBandwidthSummaryPeriodId parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            GetLatestMonthlyBandwidthSummaryPeriodId object =
                new GetLatestMonthlyBandwidthSummaryPeriodId();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"getLatestMonthlyBandwidthSummaryPeriodId".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (GetLatestMonthlyBandwidthSummaryPeriodId)org.wso2.carbon.bam.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
