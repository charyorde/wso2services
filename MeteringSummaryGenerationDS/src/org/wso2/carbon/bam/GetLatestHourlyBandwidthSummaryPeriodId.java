...
/**
 * GetLatestHourlyBandwidthSummaryPeriodId.java
 *
 ...
 */
            ...
            /**
            *  GetLatestHourlyBandwidthSummaryPeriodId bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class GetLatestHourlyBandwidthSummaryPeriodId
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":getLatestHourlyBandwidthSummaryPeriodId",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "getLatestHourlyBandwidthSummaryPeriodId",
    ...
    public static class Factory{
        ...
        */
        public static GetLatestHourlyBandwidthSummaryPeriodId parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            GetLatestHourlyBandwidthSummaryPeriodId object =
                new GetLatestHourlyBandwidthSummaryPeriodId();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"getLatestHourlyBandwidthSummaryPeriodId".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (GetLatestHourlyBandwidthSummaryPeriodId)org.wso2.carbon.bam.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
