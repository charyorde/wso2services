...
/**
 * GetLatestYearlyBandwidthSummaryPeriodId.java
 *
 ...
 */
            ...
            /**
            *  GetLatestYearlyBandwidthSummaryPeriodId bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class GetLatestYearlyBandwidthSummaryPeriodId
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":getLatestYearlyBandwidthSummaryPeriodId",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "getLatestYearlyBandwidthSummaryPeriodId",
    ...
    public static class Factory{
        ...
        */
        public static GetLatestYearlyBandwidthSummaryPeriodId parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            GetLatestYearlyBandwidthSummaryPeriodId object =
                new GetLatestYearlyBandwidthSummaryPeriodId();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"getLatestYearlyBandwidthSummaryPeriodId".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (GetLatestYearlyBandwidthSummaryPeriodId)org.wso2.carbon.bam.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
