...
/**
 * GetLatestDailyRegistryBandwidthSummaryPeriodId.java
 *
 ...
 */
            ...
            /**
            *  GetLatestDailyRegistryBandwidthSummaryPeriodId bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class GetLatestDailyRegistryBandwidthSummaryPeriodId
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":getLatestDailyRegistryBandwidthSummaryPeriodId",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "getLatestDailyRegistryBandwidthSummaryPeriodId",
    ...
    public static class Factory{
        ...
        */
        public static GetLatestDailyRegistryBandwidthSummaryPeriodId parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            GetLatestDailyRegistryBandwidthSummaryPeriodId object =
                new GetLatestDailyRegistryBandwidthSummaryPeriodId();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"getLatestDailyRegistryBandwidthSummaryPeriodId".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (GetLatestDailyRegistryBandwidthSummaryPeriodId)org.wso2.carbon.bam.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
