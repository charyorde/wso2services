 ...
 */
            ...
            /**
            *  GetMinimumPeriodId bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class GetMinimumPeriodId
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":getMinimumPeriodId",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "getMinimumPeriodId",
    ...
    public static class Factory{
        ...
        */
        public static GetMinimumPeriodId parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            GetMinimumPeriodId object =
                new GetMinimumPeriodId();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"getMinimumPeriodId".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (GetMinimumPeriodId)org.wso2.carbon.bam.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
