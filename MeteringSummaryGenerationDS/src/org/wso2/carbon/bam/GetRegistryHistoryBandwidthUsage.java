...
/**
 * GetRegistryHistoryBandwidthUsage.java
 *
 ...
 */
            ...
            /**
            *  GetRegistryHistoryBandwidthUsage bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class GetRegistryHistoryBandwidthUsage
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":getRegistryHistoryBandwidthUsage",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "getRegistryHistoryBandwidthUsage",
    ...
    public static class Factory{
        ...
        */
        public static GetRegistryHistoryBandwidthUsage parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            GetRegistryHistoryBandwidthUsage object =
                new GetRegistryHistoryBandwidthUsage();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"getRegistryHistoryBandwidthUsage".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (GetRegistryHistoryBandwidthUsage)org.wso2.carbon.bam.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
